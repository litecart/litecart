...
CREATE TABLE `lc_stock_items` (
	...
	`weight` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
	`weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`length` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
	`width` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
	`height` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
	`length_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`quantity` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
	`quantity_unit_id` INT(10) UNSIGNED NULL,
	`backordered` DECIMAL(11,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_stock_transactions_contents` (
	...
	`quantity_adjustment` DECIMAL(11,4) NOT NULL DEFAULT '0',
	PRIMARY KEY (`id`),
...
CHANGE COLUMN `value` `value` DECIMAL(11,6) UNSIGNED NOT NULL DEFAULT '1.000000',
...
ADD COLUMN `intl_locale` VARCHAR(16) NOT NULL DEFAULT '' AFTER `locale`,
ADD COLUMN `mysql_collation` VARCHAR(32) NOT NULL DEFAULT '' AFTER `intl_locale`,
...
CHANGE COLUMN `payment_due` `total` DECIMAL(11,4) NOT NULL DEFAULT '0',
CHANGE COLUMN `tax_total` `total_tax` DECIMAL(11,4) NOT NULL DEFAULT '0',
CHANGE COLUMN `client_ip` `ip_address` VARCHAR(39) NOT NULL DEFAULT '',
...
ADD COLUMN `shipping_purchase_cost` DECIMAL(11,4) NOT NULL DEFAULT '0.0000' AFTER `shipping_option_tax`,
...
ADD COLUMN `payment_transaction_fee` DECIMAL(11,4) NOT NULL DEFAULT '0' AFTER `payment_transaction_id`,
ADD COLUMN `subtotal` DECIMAL(11,4) NOT NULL DEFAULT '0' AFTER `display_prices_including_tax`,
ADD COLUMN `subtotal_tax` DECIMAL(11,4) NOT NULL DEFAULT '0' AFTER `subtotal`,
ADD COLUMN `discount` DECIMAL(11,4) NOT NULL DEFAULT '0' AFTER `subtotal_tax`,
...
CHANGE COLUMN `id` `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
CHANGE COLUMN `order_id` `order_id` INT(10) UNSIGNED NOT NULL,
CHANGE COLUMN `value` `amount` DECIMAL(11,4) NOT NULL DEFAULT '0',
CHANGE COLUMN `calculate` `calculate` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
ADD COLUMN `tax_rate` DECIMAL(6,4) UNSIGNED NOT NULL DEFAULT '0.0000',
ADD COLUMN `discount` DECIMAL(11,4) NOT NULL DEFAULT '0' AFTER `amount`;
-- -----
...
CHANGE COLUMN `quantity_step` `quantity_step` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
CHANGE COLUMN `quantity_unit_id` `quantity_unit_id` INT(10) UNSIGNED NULL,
CHANGE COLUMN `weight` `weight` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0',
CHANGE COLUMN `weight_class` `weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
CHANGE COLUMN `dim_x` `length` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0',
CHANGE COLUMN `dim_y` `width` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0',
CHANGE COLUMN `dim_z` `height` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0',
CHANGE COLUMN `dim_class` `length_unit` VARCHAR(2) NOT NULL DEFAULT '',
...
ADD COLUMN `pinned` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0' AFTER `featured`,
...
ADD COLUMN `price_adjustment` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '0' AFTER `price_modifier`;
-- -----
...
ADD COLUMN `min_quantity` DECIMAL(10,4) UNSIGNED NOT NULL DEFAULT '1' AFTER `geo_zone_id`,
...
CHANGE COLUMN `rate` `rate` DECIMAL(4,2) NOT NULL DEFAULT '0',
DROP COLUMN `type`;
-- -----
ALTER TABLE `lc_tax_rates`
CHANGE COLUMN `id` `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
CHANGE COLUMN `tax_class_id` `tax_class_id` INT(10) UNSIGNED NOT NULL,
CHANGE COLUMN `geo_zone_id` `geo_zone_id` INT(10) UNSIGNED NOT NULL,
CHANGE COLUMN `rate` `rate` DECIMAL(6,4) UNSIGNED NOT NULL DEFAULT '0.0000',
...
ADD COLUMN `text` TEXT NOT NULL DEFAULT '{}' COMMENT 'TYPE:JSON_TRANSLATIONS' AFTER `language_code`;
-- -----
