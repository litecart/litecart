<?php
	...
	perform_action('delete', [
		...
		FS_DIR_APP .'includes/abstracts/index.html',
		...
		FS_DIR_APP .'includes/boxes/box_cookie_notice.inc.php',
		...
		FS_DIR_APP .'includes/entities/ent_attribute_group.inc.php',
		FS_DIR_APP .'includes/entities/ent_category.inc.php',
		FS_DIR_APP .'includes/entities/ent_country.inc.php',
		FS_DIR_APP .'includes/entities/ent_currency.inc.php',
		FS_DIR_APP .'includes/entities/ent_customer.inc.php',
		FS_DIR_APP .'includes/entities/ent_delivery_status.inc.php',
		FS_DIR_APP .'includes/entities/ent_email.inc.php',
		FS_DIR_APP .'includes/entities/ent_geo_zone.inc.php',
		FS_DIR_APP .'includes/entities/ent_image.inc.php',
		FS_DIR_APP .'includes/entities/ent_language.inc.php',
		FS_DIR_APP .'includes/entities/ent_link.inc.php',
		FS_DIR_APP .'includes/entities/ent_manufacturer.inc.php',
		FS_DIR_APP .'includes/entities/ent_module.inc.php',
		FS_DIR_APP .'includes/entities/ent_order_status.inc.php',
		FS_DIR_APP .'includes/entities/ent_order.inc.php',
		FS_DIR_APP .'includes/entities/ent_page.inc.php',
		FS_DIR_APP .'includes/entities/ent_product.inc.php',
		FS_DIR_APP .'includes/entities/ent_quantity_unit.inc.php',
		FS_DIR_APP .'includes/entities/ent_slide.inc.php',
		FS_DIR_APP .'includes/entities/ent_sold_out_status.inc.php',
		FS_DIR_APP .'includes/entities/ent_supplier.inc.php',
		FS_DIR_APP .'includes/entities/ent_tax_class.inc.php',
		FS_DIR_APP .'includes/entities/ent_tax_rate.inc.php',
		FS_DIR_APP .'includes/entities/ent_user.inc.php',
		FS_DIR_APP .'includes/entities/ent_view.inc.php',
		FS_DIR_APP .'includes/entities/ent_vmod.inc.php',
		FS_DIR_APP .'includes/entities/index.html',
		FS_DIR_APP .'includes/functions/func_admin.inc.php',
		FS_DIR_APP .'includes/functions/func_captcha.inc.php',
		FS_DIR_APP .'includes/functions/func_catalog.inc.php',
		FS_DIR_APP .'includes/functions/func_csv.inc.php',
		FS_DIR_APP .'includes/functions/func_draw.inc.php',
		FS_DIR_APP .'includes/functions/func_escape.inc.php',
		FS_DIR_APP .'includes/functions/func_file.inc.php',
		FS_DIR_APP .'includes/functions/func_form.inc.php',
		FS_DIR_APP .'includes/functions/func_format.inc.php',
		FS_DIR_APP .'includes/functions/func_general.inc.php',
		FS_DIR_APP .'includes/functions/func_image.inc.php',
		FS_DIR_APP .'includes/functions/func_password.inc.php',
		FS_DIR_APP .'includes/functions/func_reference.inc.php',
		FS_DIR_APP .'includes/functions/func_validate.inc.php',
		FS_DIR_APP .'includes/functions/index.html',
		...
		FS_DIR_APP .'includes/modules/index.html',
		FS_DIR_APP .'includes/modules/mod_customer.inc.php',
		FS_DIR_APP .'includes/modules/mod_jobs.inc.php',
		FS_DIR_APP .'includes/modules/mod_order_total.inc.php',
		FS_DIR_APP .'includes/modules/mod_order.inc.php',
		FS_DIR_APP .'includes/modules/mod_payment.inc.php',
		FS_DIR_APP .'includes/modules/mod_shipping.inc.php',
		FS_DIR_APP .'includes/modules/customer/index.html',
		FS_DIR_APP .'includes/modules/jobs/index.html',
		FS_DIR_APP .'includes/modules/jobs/job_cache_cleaner.inc.php',
		FS_DIR_APP .'includes/modules/jobs/job_error_reporter.inc.php',
		FS_DIR_APP .'includes/modules/jobs/job_mysql_optimizer.inc.php',
		FS_DIR_APP .'includes/modules/order/index.html',
		...
		FS_DIR_APP .'includes/modules/payment/index.html',
		FS_DIR_APP .'includes/modules/payment/pm_cod.inc.php',
		FS_DIR_APP .'includes/modules/shipping/index.html',
		FS_DIR_APP .'includes/modules/shipping/sm_zone_weight.inc.php',
		FS_DIR_APP .'includes/references/index.html',
		FS_DIR_APP .'includes/references/ref_category.inc.php',
		FS_DIR_APP .'includes/references/ref_country.inc.php',
		FS_DIR_APP .'includes/references/ref_customer.inc.php',
		FS_DIR_APP .'includes/references/ref_manufacturer.inc.php',
		FS_DIR_APP .'includes/references/ref_order_status.inc.php',
		FS_DIR_APP .'includes/references/ref_page.inc.php',
		FS_DIR_APP .'includes/references/ref_product.inc.php',
		...
		FS_DIR_APP .'includes/templates/default.admin/index.html',
		FS_DIR_APP .'includes/templates/default.admin/css/app.min.css',
		FS_DIR_APP .'includes/templates/default.admin/css/app.min.css.map',
		FS_DIR_APP .'includes/templates/default.admin/css/framework.min.css',
		FS_DIR_APP .'includes/templates/default.admin/css/framework.min.css.map',
		FS_DIR_APP .'includes/templates/default.admin/css/index.html',
		FS_DIR_APP .'includes/templates/default.admin/css/printable.min.css',
		FS_DIR_APP .'includes/templates/default.admin/css/printable.min.css.map',
		FS_DIR_APP .'includes/templates/default.admin/css/variables.css',
		FS_DIR_APP .'includes/templates/default.admin/fonts/index.html',
		FS_DIR_APP .'includes/templates/default.admin/fonts/roboto-v32-latin_latin-ext-700.woff2',
		FS_DIR_APP .'includes/templates/default.admin/fonts/roboto-v32-latin_latin-ext-regular.woff2',
		FS_DIR_APP .'includes/templates/default.admin/images/background.svg',
		FS_DIR_APP .'includes/templates/default.admin/images/index.html',
		FS_DIR_APP .'includes/templates/default.admin/images/loader.svg',
		FS_DIR_APP .'includes/templates/default.admin/images/logotype.svg',
		FS_DIR_APP .'includes/templates/default.admin/js/app.js',
		FS_DIR_APP .'includes/templates/default.admin/js/app.min.js',
		FS_DIR_APP .'includes/templates/default.admin/js/app.min.js.map',
		FS_DIR_APP .'includes/templates/default.admin/layouts/ajax.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/layouts/default.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/layouts/index.html',
		FS_DIR_APP .'includes/templates/default.admin/layouts/login.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/layouts/printable.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/less/app.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework.less',
		FS_DIR_APP .'includes/templates/default.admin/less/index.html',
		FS_DIR_APP .'includes/templates/default.admin/less/printable.less',
		FS_DIR_APP .'includes/templates/default.admin/less/variables.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/animations.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/base.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/breadcrumbs.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/buttons.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/cards.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/chat.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/dropdown.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/effects.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/grid.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/images.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/index.html',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/inputs.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/lists.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/loader.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/media.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/nav.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/normalize.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/notices.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/pagination.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/tables.less',
		FS_DIR_APP .'includes/templates/default.admin/less/framework/typography.less',
		FS_DIR_APP .'includes/templates/default.admin/pages/about.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/pages/doc.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/pages/error_document.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/pages/login.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/views/box_apps_menu.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/views/box_widgets.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/views/breadcrumbs.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/views/notices.inc.php',
		FS_DIR_APP .'includes/templates/default.admin/views/pagination.inc.php',
		...
		FS_DIR_APP .'includes/templates/default.catalog/less/framework/cards.less',
		...
		FS_DIR_APP .'includes/templates/default.catalog/less/framework/media.less',
		...
		FS_DIR_APP .'includes/templates/default.catalog/views/box_checkout_no_items.inc.php',
		...
		FS_DIR_APP .'includes/app_footer.inc.php',
		FS_DIR_APP .'includes/app_header.inc.php',
		FS_DIR_APP .'includes/autoloader.inc.php',
		FS_DIR_APP .'includes/compatibility.inc.php',
		FS_DIR_APP .'includes/error_handler.inc.php',
		FS_DIR_APP .'includes/index.html',
	...
	foreach (glob(FS_DIR_APP . 'includes/abstracts/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/abstracts/' . basename($file)]);
	}
	...
	foreach (glob(FS_DIR_APP . 'includes/entities/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/entities/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/functions/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/functions/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/customer/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/customer/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/jobs/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/jobs/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/order/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/order/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/order_total/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/order_total/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/payment/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/payment/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/shipping/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/shipping/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/modules/mod_*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/modules/' . basename($file)]);
	}

	foreach (glob(FS_DIR_APP . 'includes/references/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/references/' . basename($file)]);
	}
	...
	foreach (glob(FS_DIR_APP . 'includes/wrappers/*') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/clients/' . preg_replace('#^wrap_(.*)\.inc\.php$#', '$1_client.inc.php', basename($file))]);
	}

	foreach (glob(FS_DIR_APP . 'includes/*.inc.php') as $file) {
		perform_action('move', [$file => FS_DIR_APP . 'shared/' . basename($file)]);
	}
