<?php
	...
	perform_action('delete', [
		...
		FS_DIR_APP . 'includes/abstracts/',
		FS_DIR_APP . 'includes/app_footer.inc.php',
		FS_DIR_APP . 'includes/app_header.inc.php',
		FS_DIR_APP . 'includes/autoloader.inc.php',
		FS_DIR_APP . 'includes/clients/',
		FS_DIR_APP . 'includes/collections.inc.php',
		FS_DIR_APP . 'includes/compatibility.inc.php',
		FS_DIR_APP . 'includes/entities/',
		FS_DIR_APP . 'includes/error_handler.inc.php',
		FS_DIR_APP . 'includes/functions/',
		FS_DIR_APP . 'includes/index.html',
		FS_DIR_APP . 'includes/modules/',
		FS_DIR_APP . 'includes/nodes/',
		FS_DIR_APP . 'includes/references/',
		FS_DIR_APP . 'includes/shorthand.inc.php',
		FS_DIR_APP . 'includes/streams/',
		FS_DIR_APP . 'includes/types/',
		FS_DIR_APP . 'includes/',
		FS_DIR_APP . 'logs/',
		FS_DIR_APP . 'ext/',
		FS_DIR_APP . 'pages/',
