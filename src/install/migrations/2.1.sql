...
('email', 'local', 'SMTP Enabled', 'Whether or not to use an SMTP server for delivering email.', 'smtp_status', '0', 'toggle("e/d")', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('email', 'local', 'SMTP Host', 'SMTP hostname e.g. smtp.myprovider.com.', 'smtp_host', 'localhost', 'input()', 11, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('email', 'local', 'SMTP Port', 'SMTP port e.g. 25, 465 (SSL/TLS), or 587 (STARTTLS).', 'smtp_port', '25', 'number()', 12, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('email', 'local', 'SMTP Username', 'Username for SMTP authentication.', 'smtp_username', '', 'input()', 13, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('email', 'local', 'SMTP Password', 'Password for SMTP authentication.', 'smtp_password', '', 'input()', 14, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
