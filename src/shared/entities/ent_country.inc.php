<?php
	...
	class ent_country {
		...
		public function reset(): void {
			...
			foreach (database::schema(DB_PREFIX .'countries') as $field) {
		...
		public function load(string $country_code): void {
			...
			$country = database::query(
				...
				". (preg_match('#^\d+$#', $country_code) ? "where id = ". (int)$country_code : "") ."
		...
		public function save(): void {
			...
			if (database::query(
				...
				throw new Exception(t('error_country_conflict', 'The country conflicts another country in the database'));
			}
		...
		public function delete(): void {
			...
			database::query(
				...
				left join ". DB_PREFIX ."zones z on (z.country_code = c.iso_code_2)
