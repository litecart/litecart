<?php
	...
	try {
		...
		$auto_increment_id = database::query(
			"SHOW TABLE STATUS LIKE '". DB_PREFIX ."customer_groups';"
		...
		if (database::query(
			"select id from ". DB_PREFIX ."customer_groups
		...
		database::query(
			"ALTER TABLE ". DB_PREFIX ."customer_groups AUTO_INCREMENT = ". (int)$auto_increment_id .";"
		);
	}
