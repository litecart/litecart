<?php
	...
	try {
		...
		$auto_increment_id = database::query(
			"SHOW TABLE STATUS LIKE '". DB_PREFIX ."stock_transactions';"
		...
		if (database::query(
			"select id from ". DB_PREFIX ."stock_transactions
		...
		database::query(
			"ALTER TABLE ". DB_PREFIX ."stock_transactions AUTO_INCREMENT = ". (int)$auto_increment_id .";"
		);
	}
