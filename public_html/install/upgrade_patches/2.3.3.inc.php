<?php
  ...
  if (database::query("SHOW COLUMNS FROM ". DB_TABLE_PREFIX ."customers LIKE 'num_logins';")->num_rows) {
    database::query(
  ...
  if (!database::query("SHOW COLUMNS FROM ". DB_TABLE_PREFIX ."newsletter_recipients LIKE 'client_ip';")->num_rows) {
    database::query(
