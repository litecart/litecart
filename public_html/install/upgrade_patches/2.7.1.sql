...
('security', 'global', 'csrf_protection', '1', 'CSRF-Protection', 'Enable CSRF (Cross-Site Request Forgery) protection for form submissions.', 'toggle()', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('security', 'global', 'bot_challenge', '1', 'Bot Challenge', 'Challenge clients with a simple JavaScript challenge', 'toggle()', 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
