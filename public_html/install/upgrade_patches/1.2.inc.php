<?php
  ...
  file_rename(FS_DIR_APP . 'pages/ajax', FS_DIR_APP . 'pages/ajax.deleteme');
  file_rename(FS_DIR_APP . 'pages/feeds', FS_DIR_APP . 'pages/feeds.deleteme');

  $modified_files = array(
    array(
      'file'    => FS_DIR_ADMIN . '.htaccess',
    ...
    array(
      'file'    => FS_DIR_APP . 'pages/.htaccess',
