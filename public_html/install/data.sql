...
('site_info', 'local', 'Site Tax ID', 'The site\'s tax ID or VATIN.', 'site_tax_id', 'XX000000000000', 'text()', 0, 12, NOW(), NOW()),
('site_info', 'local', 'Site Postal Address', 'The site\'s postal address.', 'site_postal_address', 'My Store\r\nStreet\r\nPostcode City\r\nCountry', 'bigtext()', 0, 13, NOW(), NOW()),
('site_info', 'local', 'Site Visiting Address', 'The physical site address, if applicable.', 'site_visiting_address', '', 'bigtext()', 0, 14, NOW(), NOW()),
('site_info', 'local', 'Site Phone Number', 'The site\'s phone number.', 'site_phone', '+1-212-555-DUCK', 'text()', 0, 15, NOW(), NOW()),
('site_info', 'global', 'Site Country', 'The country of your site.', 'site_country_code', '{STORE_COUNTRY_CODE}', 'country()', 0, 16, NOW(), NOW()),
('site_info', 'global', 'Site Zone', 'The zone of your site.', 'site_zone_code', '', 'zone("default_zone_code")', 0, 17, NOW(), NOW()),
('site_info', 'global', 'Site Postcode', 'The postcode of your site.', 'site_postcode', '', 'text()', 0, 18, NOW(), NOW()),
('site_info', 'global', 'Site Time Zone', 'The site\'s time zone.', 'site_timezone', '{STORE_TIME_ZONE}', 'timezone()', 1, 19, NOW(), NOW()),
('site_info', 'local', 'Site Language', 'The spoken language of your organization.', 'site_language_code', 'en', 'language()', 1, 20, NOW(), NOW()),
('site_info', 'global', 'Site Currency', 'The currency which all prices conform to.', 'site_currency_code', 'USD', 'currency()', 1, 21, NOW(), NOW()),
('site_info', 'global', 'Site Weight Unit', 'The preferred weight unit.', 'site_weight_unit', 'kg', 'weight_unit()', 1, 22, NOW(), NOW()),
('site_info', 'global', 'Site Length Unit', 'The preferred length unit.', 'site_length_unit', 'cm', 'length_unit()', 1, 23, NOW(), NOW()),
...
('listings', 'global', 'Maintenance Mode', 'Setting the store in maintenance mode will prevent users from browsing your site.', 'maintenance_mode', '0', 'toggle()', 0, 2, NOW(), NOW()),
...
('listings', 'local', 'Latest Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_latest_products_num_items', '8', 'number()', 0, 17, NOW(), NOW()),
('listings', 'local', 'Popular Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_popular_products_num_items', '8', 'number()', 0, 18, NOW(), NOW()),
('listings', 'local', 'Campaign Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_campaign_products_num_items', '4', 'number()', 0, 19, NOW(), NOW()),
...
('images', 'local', 'Category Images: Clipping Method', 'The clipping method used for scaled category thumbnails.', 'category_image_clipping', 'CROP', 'select("CROP","FIT","FIT_USE_WHITESPACING")', 0, 11, NOW(), NOW()),
...
('images', 'local', 'Product Images: Clipping Method', 'The clipping method used for scaled product thumbnails.', 'product_image_clipping', 'FIT_USE_WHITESPACING', 'select("CROP","FIT","FIT_USE_WHITESPACING")', 0, 31, NOW(), NOW()),
...
('advanced', 'global', 'Jobs Last Run', 'Time when background jobs were last executed.', 'jobs_last_run', NOW(), 'text()', 0, 16, NOW(), NOW()),
('advanced', 'local', 'Jobs Interval', 'The amount of minutes between each execution of jobs.', 'jobs_interval', '60', 'number()', 0, 17, NOW(), NOW()),
