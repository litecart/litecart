...
('site_info', 'global', 'Site Name', 'The name of your site.', 'site_name', '{STORE_NAME}', 'text()', 10, NOW(), NOW()),
('site_info', 'global', 'Site Email', 'The site\'s email address.', 'site_email', '{STORE_EMAIL}', 'text()', 11, NOW(), NOW()),
('site_info', 'local', 'Site Tax ID', 'The site\'s tax ID or VATIN.', 'site_tax_id', 'XX000000000000', 'text()', 12, NOW(), NOW()),
('site_info', 'local', 'Site Postal Address', 'The site\'s postal address.', 'site_postal_address', 'My Store\r\nStreet\r\nPostcode City\r\nCountry', 'bigtext()', 13, NOW(), NOW()),
('site_info', 'local', 'Site Visiting Address', 'The physical site address, if applicable.', 'site_visiting_address', '', 'bigtext()', 14, NOW(), NOW()),
('site_info', 'local', 'Site Phone Number', 'The site\'s phone number.', 'site_phone', '+1-212-555-DUCK', 'text()', 15, NOW(), NOW()),
('site_info', 'global', 'Site Country', 'The country of your site.', 'site_country_code', '{STORE_COUNTRY_CODE}', 'country()', 16, NOW(), NOW()),
...
('site_info', 'global', 'Site Time Zone', 'The site\'s time zone.', 'site_timezone', '{STORE_TIME_ZONE}', 'timezone()', 19, NOW(), NOW()),
...
('site_info', 'global', 'Site Weight Unit', 'The preferred weight unit.', 'site_weight_unit', 'kg', 'weight_unit()', 22, NOW(), NOW()),
('site_info', 'global', 'Site Length Unit', 'The preferred length unit.', 'site_length_unit', 'cm', 'length_unit()', 23, NOW(), NOW()),
...
('advanced', 'global', 'Static Content Domain Name', 'Use the given alias domain name for static content (images, stylesheets, javascripts).', 'static_domain', '', 'text()', 12, NOW(), NOW()),
...
('', 'global', 'Template', '', 'site_template', 'default', 'template()', 0, NOW(), NOW()),
