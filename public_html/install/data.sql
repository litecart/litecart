...
(5, 'job_cleaner', 'job', 1, 0, '{"status":"1","priority":"0"}', '', NOW(), NOW()),
...
('security', 'global', 'CSRF-Protection', 'Enable CSRF (Cross-Site Request Forgery) protection for form submissions.', 'csrf_protection', '1', 'toggle()', 10, NOW(), NOW()),
('security', 'global', 'Bot Challenge', 'Challenge clients with a simple JavaScript challenge', 'bot_challenge', '1', 'toggle()', 30, NOW(), NOW()),
('security', 'global', 'Whitelisted User Agents', 'A comma-separated list of substrings for matching User-Agent headers that are exempt from bot detection.', 'whitelisted_user_agents', 'adsbot-google, adidxbot, ahrefsbot, amazonbot, anthropic-ai, applebot, baiduspider, bingbot, bingpreview, ccbot, chatgpt-user, chrome-lighthouse, claudebot, claude-searchbot, claude-user, claude-web, crisp, dixa, dotbot, duckassistbot, duckduckbot, exabot, facebookbot, facebookexternalhit, facebot, google-inspectiontool, googlebot, gptbot, ia_archiver, librecrawl, mediapartners-google, meta-externalads, meta-externalagent, microsoftpreview, mistralai-user, msnbot, oai-searchbot, perplexity-user, perplexitybot, petalbot, rsiteauditor, salesmanago, semrushbot, slurp, sogou', 'bigtext()', 40, NOW(), NOW()),
('security', 'global', 'Whitelisted Hostnames', 'A list of hostnames that are exempt from bot detection. One hostname suffix per line (e.g. ".googlebot.com").', 'whitelisted_hostnames', '.apple.com\n.baidu.com\n.bing.com\n.cloudflare.com\n.duckduckgo.com\n.facebook.com\n.fbsv.net\n.google.com\n.googlebot.com\n.meta.com\n.paypal.com\n.stripe.com\n.telegram.org\n.yahoo.com\n.yandex.com\n.yandex.net\n.yandex.ru', 'bigtext()', 41, NOW(), NOW()),
