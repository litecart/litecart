...
('images', 'local', 'Image Lazy Loading', 'Tells the browser to load images on the pages first when they are scrolled down to.', 'image_lazyload', '0', 'toggle("e/d")', '45', NOW(), NOW()),
