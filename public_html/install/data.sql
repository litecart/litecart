...
('store_info', 'global', 'Store Email', 'The store e-mail address.', 'store_email', '{STORE_EMAIL}', 'text()', 11, NOW(), NOW()),
('store_info', 'local', 'Store Tax ID', 'The store tax ID or VATIN.', 'store_tax_id', 'XX000000000000', 'text()', 12, NOW(), NOW()),
...
('store_info', 'local', 'Store Phone Number', 'The store phone number.', 'store_phone', '+1-212-555-DUCK', 'text()', 15, NOW(), NOW()),
('store_info', 'global', 'Store Country', 'The country of your store.', 'store_country_code', '{STORE_COUNTRY_CODE}', 'country()', 16, NOW(), NOW()),
('store_info', 'global', 'Store Zone', 'The zone of your store.', 'store_zone_code', '', 'zones()', 17, NOW(), NOW()),
('store_info', 'global', 'Store Time Zone', 'The store time zone.', 'store_timezone', '{STORE_TIME_ZONE}', 'timezone()', 18, NOW(), NOW()),
('store_info', 'local', 'Store Language', 'The spoken language of your organization.', 'store_language_code', 'en', 'language()', 19, NOW(), NOW()),
('store_info', 'global', 'Store Currency', 'The currency of which all prices conform to.', 'store_currency_code', 'USD', 'currency()', 20, NOW(), NOW()),
('store_info', 'global', 'Store Weight Class', 'The prefered weight class.', 'store_weight_class', 'kg', 'weight_class()', 21, NOW(), NOW()),
('store_info', 'global', 'Store Length Class', 'The prefered length class.', 'store_length_class', 'cm', 'length_class()', 22, NOW(), NOW()),
('defaults', 'global', 'Default Language', 'The default language selected, if failed to identify.', 'default_language_code', 'en', 'language()', 10, NOW(), NOW()),
('defaults', 'global', 'Default Currency', 'The default currency selected, if failed to identify.', 'default_currency_code', 'USD', 'currency()', 11, NOW(), NOW()),
('defaults', 'global', 'Default Country', 'The default country selected if not set otherwise.', 'default_country_code', '{STORE_COUNTRY_CODE}', 'country()', 12, NOW(), NOW()),
('defaults', 'global', 'Default Zone', 'The default zone selected if not set otherwise.', 'default_zone_code', '', 'zone()', 13, NOW(), NOW()),
('defaults', 'local', 'Default Tax Class', 'Default tax class that will be preset when creating new products.', 'default_tax_class_id', '1', 'tax_class()', 14, NOW(), NOW()),
...
('defaults', 'global', 'Default Quantity Unit', 'Default quantity unit that will be preset when creating new products.', 'default_quantity_unit_id', '1', 'quantity_unit()', 16, NOW(), NOW()),
('defaults', 'global', 'Default Sold Out Status', 'Default sold out status that will be preset when creating new products.', 'default_sold_out_status_id', '1', 'sold_out_status()', 17, NOW(), NOW()),
('defaults', 'global', 'Default Delivery Status', 'Default delivery status that will be preset when creating new products.', 'default_delivery_status_id', '1', 'delivery_status()', 18, NOW(), NOW()),
('email', 'local', 'Send Emails', 'Wheither or not the platform should deliver outgoing emails.', 'email_status', '1', 'toggle("y/n")', 1, NOW(), NOW()),
...
('listings', 'local', 'Data Table Rows', 'The number of data table rows per page.', 'data_table_rows_per_page', '25', 'text()', 11, NOW(), NOW()),
...
('listings', 'local', 'Max Age for New Products', 'Display the new sticker for products younger than the give age. E.g. 1 month or 14 days', 'new_products_max_age', '1 month', 'text()', 14, NOW(), NOW()),
('listings', 'local', 'Similar Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_similar_products_num_items', '8', 'number()', 15, NOW(), NOW()),
('listings', 'local', 'Recently Viewed Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_recently_viewed_products_num_items', '4', 'number()', 16, NOW(), NOW()),
('listings', 'local', 'Latest Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_latest_products_num_items', '8', 'number()', 17, NOW(), NOW()),
('listings', 'local', 'Popular Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_popular_products_num_items', '8', 'number()', 18, NOW(), NOW()),
('listings', 'local', 'Campaign Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_campaign_products_num_items', '4', 'number()', 19, NOW(), NOW()),
('listings', 'local', 'Also Purchased Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_also_purchased_products_num_items', '4', 'number()', 20, NOW(), NOW()),
...
('checkout', 'local', 'Order Copy Recipients', 'Send order copies to the following e-mail addresses. Separate by semi-colons.', 'email_order_copy', '{STORE_EMAIL}', 'text()', 12, NOW(), NOW()),
...
('advanced', 'global', 'Jobs Last Run', 'Time when background jobs where last executed.', 'jobs_last_run', NOW(), 'text()', 16, NOW(), NOW()),
('advanced', 'local', 'Jobs Interval', 'The amount of minutes between each execution of jobs.', 'jobs_interval', '60', 'number()', 17, NOW(), NOW()),
('advanced', 'local', 'Database Admin Link', 'The URL to your database manager e.g. phpMyAdmin.', 'database_admin_link', '?app=settings&doc=advanced&action=edit&key=database_admin_link', 'text()', 18, NOW(), NOW()),
('advanced', 'local', 'Webmail Link', 'The URL to your webmail client.', 'webmail_link', '?app=settings&doc=advanced&action=edit&key=webmail_link', 'text()', 19, NOW(), NOW()),
...
('security', 'global', 'Bad URLs Access Detection', 'Detect access to commonly attacked URLs.', 'security_bad_urls', '0', 'toggle("e/d")', 15, NOW(), NOW()),
...
('', 'global', 'Jobs Last Push', 'Time when background jobs where last pushed for execution.', 'jobs_last_push', NOW(), 'text()', 0, NOW(), NOW()),
('', 'local', 'Date Cache Cleared', 'Do not use system cache older than breakpoint.', 'cache_system_breakpoint', NOW(), 'text()', 0, NOW(), NOW()),
('', 'local', 'Errors Last Reported', 'Time when errors where last reported by the background job.', 'job_error_reporter:last_run', NOW(), 'text()', 0, NOW(), NOW());
-- --------------------------------------------------------
