...
('customer_details', 'Listings', 'Settings for the catalog listing', 45),
...
('store_info', 'global', 'Store Time Zone', 'The store\'s time zone.', 'store_timezone', '{STORE_TIME_ZONE}', 'timezone()', 18, NOW(), NOW()),
('store_info', 'local', 'Store Language', 'The spoken language of your organization.', 'store_language_code', 'en', 'language()', 19, NOW(), NOW()),
('store_info', 'global', 'Store Currency', 'The currency which all prices conform to.', 'store_currency_code', 'USD', 'currency()', 20, NOW(), NOW()),
('store_info', 'global', 'Store Weight Class', 'The preferred weight class.', 'store_weight_class', 'kg', 'weight_class()', 21, NOW(), NOW()),
('store_info', 'global', 'Store Length Class', 'The preferred length class.', 'store_length_class', 'cm', 'length_class()', 22, NOW(), NOW()),
...
('defaults', 'global', 'Default Zone', 'The default zone, if not otherwise set.', 'default_zone_code', '', 'zone()', 13, NOW(), NOW()),
...
('customer_details', 'global', 'Regional Settings Screen', 'Enables the regional settings screen upon first visit.', 'regional_settings_screen', '0', 'toggle()', 10, NOW(), NOW()),
('customer_details', 'local', 'customer_field_company', 'Company Field', 'Display the field for the customer\'s company name.', '1', 'toggle("y/n")', 21, NOW(), NOW()),
('customer_details', 'local', 'customer_field_tax_id', 'Tax ID Field', 'Display the field for the customer\'s tax ID.', '1', 'toggle("y/n")', 22, NOW(), NOW()),
