...
('listings', 'local', 'Latest Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_latest_products_num_items', '6', 'number()', 17, NOW(), NOW()),
('listings', 'local', 'Popular Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_popular_products_num_items', '6', 'number()', 18, NOW(), NOW()),
('listings', 'local', 'Campaign Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_campaign_products_num_items', '6', 'number()', 19, NOW(), NOW()),
