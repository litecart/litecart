...
('store_info', 'global', 'Store Weight Unit', 'The preferred weight unit.', 'store_weight_unit', 'kg', 'weight_unit()', 22, NOW(), NOW()),
('store_info', 'global', 'Store Length Unit', 'The preferred length unit.', 'store_length_unit', 'cm', 'length_unit()', 23, NOW(), NOW()),
