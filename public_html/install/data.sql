...
('checkout', 'global', 'Round Amounts', 'Round currency amounts to prevent exceeding decimals. E.g. 29.99 instead of 29.9915', 'round_amounts', '1', 'toggle()', 13, NOW(), NOW()),
...
('', 'local', 'Errors Last Reported', 'Time when errors were last reported by the background job.', 'job_error_reporter:last_run', NOW(), 'text()', 0, NOW(), NOW());
-- --------------------------------------------------------
