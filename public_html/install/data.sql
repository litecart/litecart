...
(7, 'dispatched', 'fa-truck', '#99cc66', 1, 0, 1, 'commit', NOW(), NOW()),
(8, 'in_transit', 'fa-truck', '#e3ab44', 1, 0, 1, 'commit', NOW(), NOW()),
(9, 'delivered', 'fa-home', '#99cc66', 1, 1, 0, 'commit', NOW(), NOW()),
(10, 'returning', 'fa-undo', '#e3ab44', 1, 0, 1, 'reserved', NOW(), NOW()),
(11, 'returned', 'fa-building', '#99cc66', 1, 1, 0, 'commit', NOW(), NOW()),
...
('listings', 'local', 'Latest Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_latest_products_num_items', '10', 'number()', 17, NOW(), NOW()),
('listings', 'local', 'Popular Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_popular_products_num_items', '10', 'number()', 18, NOW(), NOW()),
('listings', 'local', 'Campaign Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_campaign_products_num_items', '5', 'number()', 19, NOW(), NOW()),
('listings', 'local', 'Also Purchased Products Box: Number of Items', 'The maximum number of items to be display in the box.', 'box_also_purchased_products_num_items', '5', 'number()', 20, NOW(), NOW()),
