...
<div style="columns: 320px auto; margin-bottom: 2em;">
  ...
  <ul>
    <li>5.6 - 8.6 <?php echo (version_compare(PHP_VERSION, '5.6', '>=') && version_compare(PHP_VERSION, '8.6', '<'))? '<span class="ok">['. PHP_VERSION .']</span>' : '<span class="error">['. PHP_VERSION .']</span>'; ?></li>
