...
<div style="columns: 320px auto; margin-bottom: 2em;">
  ...
  <ul>
    <li>5.4 - 8.3 <?php echo (version_compare(PHP_VERSION, '5.4', '>=') && version_compare(PHP_VERSION, '8.3', '<='))? '<span class="ok">['. PHP_VERSION .']</span>' : '<span class="error">['. PHP_VERSION .']</span>'; ?></li>
