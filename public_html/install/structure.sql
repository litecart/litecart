...
CREATE TABLE `lc_customers` (
	...
	`shipping_company` VARCHAR(32) NOT NULL DEFAULT '',
	`shipping_firstname` VARCHAR(32) NOT NULL DEFAULT '',
	`shipping_lastname` VARCHAR(32) NOT NULL DEFAULT '',
	`shipping_address1` VARCHAR(32) NOT NULL DEFAULT '',
	`shipping_address2` VARCHAR(32) NOT NULL DEFAULT '',
	...
	`shipping_phone` VARCHAR(16) NOT NULL DEFAULT '',
	`shipping_email` VARCHAR(64) NOT NULL DEFAULT '',
...
CREATE TABLE `lc_languages` (
	...
	`mysql_collation` VARCHAR(32) NOT NULL DEFAULT '',
...
CREATE TABLE `lc_orders` (
	...
	`customer_id` INT(10) UNSIGNED NULL,
	`billing_email` VARCHAR(64) NOT NULL DEFAULT '',
	`billing_tax_id` VARCHAR(24) NOT NULL DEFAULT '',
	`billing_company` VARCHAR(32) NOT NULL DEFAULT '',
	`billing_firstname` VARCHAR(32) NOT NULL DEFAULT '',
	`billing_lastname` VARCHAR(32) NOT NULL DEFAULT '',
	`billing_address1` VARCHAR(32) NOT NULL DEFAULT '',
	`billing_address2` VARCHAR(32) NOT NULL DEFAULT '',
	...
	`billing_phone` VARCHAR(16) NOT NULL DEFAULT '',
	`billing_email` VARCHAR(64) NOT NULL DEFAULT '',
	...
	`shipping_option_fee` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`shipping_option_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`shipping_purchase_cost` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	...
	`payment_option_fee` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`payment_option_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`payment_transaction_id` VARCHAR(128) NOT NULL DEFAULT '',
	`payment_transaction_fee` FLOAT(10,4) NOT NULL DEFAULT '',
	...
	`language_code` CHAR(2) NULL,
	`weight_total` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	...
	`subtotal` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`subtotal_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`discount` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`discount_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`total` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`total_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_orders_items` (
	...
	`quantity` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`price` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`tax_rate` FLOAT(4,2) NOT NULL DEFAULT '0.00',
	`discount` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`discount_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`sum` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`sum_tax` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`weight` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	`weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`length` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	`width` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	`height` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_products` (
	...
	`quantity` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`quantity_min` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '1.0000',
	`quantity_max` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	`quantity_step` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
	`quantity_unit_id` INT(10) UNSIGNED NULL,
	`weight` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0',
	`weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`length` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0',
	`width` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0',
	`height` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0',
	`length_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`backordered` INT(10) UNSIGNED NOT NULL DEFAULT '0',
	`recommended_price` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_products_prices` (
	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
	`product_id` INT(10) UNSIGNED NOT NULL,
	`customer_group_id` INT(10) UNSIGNED NULL DEFAULT NULL AFTER `product_id`,
	`min_quantity` FLOAT(10,4) UNSIGNED NOT NULL DEFAULT '1' AFTER `customer_group_id`,
	`USD` FLOAT(10,4) UNSIGNED NULL,
	`EUR` FLOAT(10,4) UNSIGNED NULL,
	PRIMARY KEY (`id`),
	KEY `product_id` (`product_id`),
	...
	CONSTRAINT `product_price_to_customer_group` FOREIGN KEY (`customer_group_id`) REFERENCES `lc_customer_groups` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;
-- -----
CREATE TABLE `lc_products_stock_options` (
	...
	`USD` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`EUR` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_stock_items` (
	...
	`weight` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`length` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`width` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`height` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`length_unit` VARCHAR(2) NOT NULL DEFAULT '',
	`quantity` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`backordered` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	`purchase_price` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `lc_stock_transactions_contents` (
	...
	`quantity_adjustment` FLOAT(10,4) NOT NULL DEFAULT '0.0000',
	PRIMARY KEY (`id`),
