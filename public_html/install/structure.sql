...
CREATE TABLE `lc_shopping_carts` (
  ...
  `payment_terms` VARCHAR(8) NOT NULL DEFAULT '',
  `incoterm` VARCHAR(3) NOT NULL DEFAULT '',
  `weight_total` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `weight_unit` VARCHAR(2) NOT NULL DEFAULT '',
  `language_code` VARCHAR(2) NOT NULL DEFAULT '',
  `currency_code` VARCHAR(3) NOT NULL DEFAULT '',
...
CREATE TABLE `lc_shopping_carts_items` (
  ...
  `final_price` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `tax` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `tax_class_id` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `discount` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `discount_tax` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `sum` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
  `sum_tax` FLOAT(11,4) NOT NULL DEFAULT '0.0000',
