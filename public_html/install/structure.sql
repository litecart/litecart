...
CREATE TABLE `lc_currencies` (
  ...
  `value` DECIMAL(12,6) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `lc_orders` (
  ...
  `language_code` VARCHAR(2) NOT NULL DEFAULT '',
  `weight_total` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `weight_class` VARCHAR(2) NOT NULL DEFAULT '',
  `currency_code` VARCHAR(3) NOT NULL DEFAULT '',
  `currency_value` DECIMAL(12,6) UNSIGNED NOT NULL DEFAULT '0',
  `display_prices_including_tax` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
  `payment_due` DECIMAL(12,4) NOT NULL DEFAULT '0',
...
CREATE TABLE `lc_orders_comments` (
  ...
  CONSTRAINT `fk_orders_comments_order` FOREIGN KEY (`order_id`) REFERENCES `lc_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET={DB_DATABASE_CHARSET} COLLATE {DB_DATABASE_COLLATION};
-- -----
CREATE TABLE `lc_orders_items` (
  ...
  `weight` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `weight_class` VARCHAR(2) NOT NULL DEFAULT '',
  `dim_x` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `dim_y` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `dim_z` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `dim_class` VARCHAR(2) NOT NULL DEFAULT '',
  `priority` INT(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  CONSTRAINT `fk_orders_items_order` FOREIGN KEY (`order_id`) REFERENCES `lc_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET={DB_DATABASE_CHARSET} COLLATE {DB_DATABASE_COLLATION};
-- -----
...
CREATE TABLE `lc_orders_totals` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  CONSTRAINT `fk_orders_totals_order` FOREIGN KEY (`order_id`) REFERENCES `lc_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET={DB_DATABASE_CHARSET} COLLATE {DB_DATABASE_COLLATION};
-- -----
...
CREATE TABLE `lc_products` (
  ...
  `quantity` DECIMAL(12,4) NOT NULL DEFAULT '0',
  `quantity_min` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0.0000',
  `quantity_max` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0.0000',
  `quantity_step` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0.0000',
  ...
  `dim_z` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `dim_class` VARCHAR(2) NOT NULL DEFAULT '',
  `purchase_price` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `purchase_price_currency_code` VARCHAR(3) NOT NULL DEFAULT '',
  `recommended_price` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `lc_products_campaigns` (
  ...
  `USD` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  `EUR` DECIMAL(12,4) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
