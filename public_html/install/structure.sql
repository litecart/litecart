...
CREATE TABLE `lc_orders` (
  ...
  `shipping_option_fee` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `shipping_option_tax` DECIMAL(11,4) NOT NULL DEFAULT '0',
  ...
  `payment_option_fee` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `payment_option_tax` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `payment_transaction_id` VARCHAR(128) NOT NULL DEFAULT '',
  `payment_receipt_url` VARCHAR(256) NOT NULL DEFAULT '',
...
CREATE TABLE `lc_orders_items` (
  ...
  `discount` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `discount_tax` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `sum` DECIMAL(11,4) NOT NULL DEFAULT '0',
  `sum_tax` DECIMAL(11,4) NOT NULL DEFAULT '0',
...
CREATE TABLE `lc_products_campaigns` (
  ...
  `USD` DECIMAL(11,4) UNSIGNED NOT NULL DEFAULT '0',
  `EUR` DECIMAL(11,4) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`)
) ENGINE={DB_ENGINE} DEFAULT CHARSET={DB_DATABASE_CHARSET} COLLATE {DB_DATABASE_COLLATION};
-- --------------------------------------------------------
...
CREATE TABLE `lc_shopping_carts_items` (
  ...
  `quantity_unit_id` INT(11) UNSIGNED NOT NULL DEFAULT '0',
  `sku` VARCHAR(32) NOT NULL DEFAULT '0.0000',
  `gtin` VARCHAR(32) NOT NULL DEFAULT '0.0000',
  `taric` VARCHAR(32) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE IF NOT EXISTS `lc_users` (
  ...
  `last_user_agent` VARCHAR(256) NOT NULL DEFAULT '',
  `date_valid_from` TIMESTAMP NULL DEFAULT NULL,
  `date_valid_to` TIMESTAMP NULL DEFAULT NULL,
