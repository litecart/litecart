...
('1', 'GTQ', '320', 'Guatemalan Quetzal', '1.00000000', '2', 'Q', '', '1', NOW());
-- -----
...
('GT_VAT', 'GT VAT Zone', 'Guatemala', NOW(), NOW());
-- -----
...
('GT_IVA', 'Guatemala IVA', 'Standard 12% IVA rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Guatemala IVA', '12%', '12.00000', NOW(), NOW());