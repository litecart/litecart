...
(1, 'sv', 'swe', 'Svenska', 'sv_SE.utf8,sv_SE.UTF-8,swedish', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', ' ', '', 0, NOW(), NOW());
-- -----
...
(1, @SE_VAT_ZONE, 'SE VAT 25%', '', 25.0000, 1, 1, 1, 1, NOW(), NOW()),
(1, @EU_VAT_ZONE, 'SE VAT 25%', '', 25.0000, 0, 1, 1, 1, NOW(), NOW()),
(2, @SE_VAT_ZONE, 'SE VAT 6%', '', 6.0000, 1, 1, 1, 1, NOW(), NOW()),
(2, @EU_VAT_ZONE, 'SE VAT 6%', '', 6.0000, 0, 1, 1, 1, NOW(), NOW()),
(3, @SE_VAT_ZONE, 'SE VAT 12%', '', 12.0000, 1, 1, 1, 1, NOW(), NOW()),
(3, @EU_VAT_ZONE, 'SE VAT 12%', '', 12.0000, 0, 1, 1, 1, NOW(), NOW());
