...
('1', 'CDF', '976', 'Congolese Franc', '1.00000000', '2', '', ' FC', '1', NOW());
-- -----
...
('CD_VAT', 'CD VAT Zone', 'Democratic Republic of the Congo', NOW(), NOW());
-- -----
...
('CD_VAT', 'DR Congo VAT', 'Standard 16% VAT rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'DR Congo VAT', '16%', '16.00000', NOW(), NOW());