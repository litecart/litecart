...
('1', 'ur', 'urd', 'اردو', 'ur_PK.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'PKR', '2', '', 'rtl', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
('1', 'PKR', '586', 'Pakistani Rupee', '1.00000000', '2', '₨', '', '1', NOW());
-- -----
...
('PK_VAT', 'PK VAT Zone', 'Pakistan', NOW(), NOW());
-- -----
...
('PK_GST', 'Pakistan GST', 'Standard 18% GST rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Pakistan GST', '18%', '18.00000', NOW(), NOW());