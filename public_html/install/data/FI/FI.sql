...
(1, 'fi', 'fin', 'Suomi', 'fi_FI.utf8,fi_FI.UTF-8,finnish', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', ' ', '', 0, NOW(), NOW());
-- -----
...
(1, @FI_VAT_ZONE, 'FI VAT 25,5%', '', 25.5000, 1, 1, 1, 1, NOW(), NOW()),
(1, @EU_VAT_ZONE, 'FI VAT 25,5%', '', 25.5000, 0, 1, 1, 1, NOW(), NOW()),
