...
(1, 'fi', 'fin', 'Suomi', 'fi_FI.utf8,fi_FI.UTF-8,finnish', 'fi_FI', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', ' ', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
('Culture', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
