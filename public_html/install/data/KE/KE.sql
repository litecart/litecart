...
('1', 'sw', 'swa', 'Kiswahili', 'sw_KE.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'KES', '2', '', 'ltr', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
('1', 'KES', '404', 'Kenyan Shilling', '1.00000000', '2', '', ' KSh', '1', NOW());
-- -----
...
VALUES(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Kenya VAT', '16%', '16.00000', NOW(), NOW());