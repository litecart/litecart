...
('1', 'ar', 'ara', 'العربية', 'ar_DZ.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', ',', '.', 'DZD', '2', '', 'rtl', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `updated_at`) VALUES
('1', 'DZD', '012', 'Algerian Dinar', '1.00000000', '2', '', ' دج', '1', CURRENT_TIMESTAMP);
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Algeria VAT', '19%', '19.00000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);