...
(1, 'lt', 'lit', 'Lietuvių', 'lt_LT.utf8,lt_LT.UTF-8,lithuanian', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', ' ', '', 0, NOW(), NOW());
-- --------------------------------------------------------
...
(1, @LT_VAT_ZONE, 'LT VAT 21%', '', 21.0000, 1, 1, 1, 1, NOW(), NOW()),
(1, @EU_VAT_ZONE, 'LT VAT 21%', '', 21.0000, 0, 1, 1, 1, NOW(), NOW());