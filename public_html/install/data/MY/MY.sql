...
('1', 'ms', 'may', 'Bahasa Melayu', 'ms_MY.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%I:%M %p', '%e %b %Y %I:%M %p', '.', ',', 'MYR', '2', '', 'ltr', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
('1', 'MYR', '458', 'Malaysian Ringgit', '1.00000000', '2', 'RM', '', '1', NOW());
-- -----
...
('MY_VAT', 'MY VAT Zone', 'Malaysia', NOW(), NOW());
-- -----
...
('MY_SST', 'Malaysia SST', 'Sales and Service Tax', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Malaysia SST (Sales)', '10%', '10.00000', NOW(), NOW());