...
('1', 'bn', 'ben', 'বাংলা', 'bn_BD.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'BDT', '2', '', 'ltr', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
('1', 'BDT', '050', 'Bangladeshi Taka', '1.00000000', '2', '৳', '', '1', NOW());
-- -----
...
('BD_VAT', 'BD VAT Zone', 'Bangladesh', NOW(), NOW());
-- -----
...
('BD_VAT', 'Bangladesh VAT', 'Standard 15% VAT rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Bangladesh VAT', '15%', '15.00000', NOW(), NOW());