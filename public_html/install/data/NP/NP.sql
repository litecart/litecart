...
('1', 'ne', 'nep', 'नेपाली', 'ne_NP.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'NPR', '2', '', 'ltr', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `updated_at`) VALUES
('1', 'NPR', '524', 'Nepalese Rupee', '1.00000000', '2', '₨', '', '1', CURRENT_TIMESTAMP);
-- -----
