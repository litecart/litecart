...
('1', 'km', 'khm', 'ភាសាខ្មែរ', 'km_KH.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'KHR', '2', '', 'ltr', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
('1', 'KHR', '116', 'Cambodian Riel', '1.00000000', '2', '៛', '', '1', NOW());
-- -----
...
('KH_VAT', 'KH VAT Zone', 'Cambodia', NOW(), NOW());
-- -----
...
('KH_VAT', 'Cambodia VAT', 'Standard 10% VAT rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Cambodia VAT', '10%', '10.00000', NOW(), NOW());