...
('1', 'am', 'amh', 'አማርኛ', 'am_ET.UTF-8', 'UTF-8', '%e %B %Y', '%e %b %Y', '%H:%M', '%e %b %Y %H:%M', '.', ',', 'ETB', '2', '', 'ltr', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `updated_at`) VALUES
('1', 'ETB', '230', 'Ethiopian Birr', '1.00000000', '2', '', ' Br', '1', CURRENT_TIMESTAMP);
-- -----
...
VALUES('ET_VAT', 'ET VAT Zone', 'Ethiopia', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
SET @VAT_ZONE_ID = LAST_INSERT_ID();
-- -----
INSERT INTO `lc_zones_to_geo_zones` (`geo_zone_id`, `country_code`, `zone_code`, `created_at`)
VALUES(@VAT_ZONE_ID, 'ET', '', CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_tax_classes` (`code`, `name`, `description`, `updated_at`, `created_at`)
VALUES('ET_VAT', 'Ethiopia VAT', 'Standard 15% VAT rate', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
VALUES(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Ethiopia VAT', '15%', '15.00000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);