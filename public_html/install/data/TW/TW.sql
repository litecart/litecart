...
('1', 'zh-TW', 'zho', '繁體中文', 'zh_TW.UTF-8', 'UTF-8', '%Y年%m月%e日', '%Y/%m/%e', '%H:%M', '%Y/%m/%e %H:%M', '.', ',', 'TWD', '0', '', 'ltr', NOW(), NOW());
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `date_updated`) VALUES
(WD', '901', 'New Taiwan Dollar', '1.00000000', '0', 'NT$', '', '1', NOW());
-- -----
...
('TW_VAT', 'TW VAT Zone', 'Taiwan', NOW(), NOW());
-- -----
...
('TW_VAT', 'Taiwan VAT', 'Business Tax 5%', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Taiwan VAT', '5%', '5.00000', NOW(), NOW());