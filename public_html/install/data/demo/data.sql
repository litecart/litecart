...
(1, 'size', '{"en": "Size"}', 'alphabetical', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'color', '{"en": "Color"}', 'priority', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_attribute_values` (`id`, `group_id`, `name`, `updated_at`, `created_at`) VALUES
(1, 1, '{"en": "Small"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, '{"en": "Medium"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 1, '{"en": "Large"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 2, '{"en": "Yellow"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, '{"en": "Green"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 2, '{"en": "Red"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 2, '{"en": "Blue"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 2, '{"en": "Purple"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_brands` (`id`, `status`, `featured`, `code`, `name`, `keywords`, `image`, `updated_at`, `created_at`) VALUES
(1, 1, 1, 'acme', 'ACME Corp.', '', 'brands/1-acme-corp.webp', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_campaigns` (`id`, `status`, `name`, `updated_at`, `created_at`) VALUES
(1, 1, 'Super Sale', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_categories` (`id`, `parent_id`, `status`, `code`, `name`, `priority`, `updated_at`, `created_at`) VALUES
(1, 0, 1, '', '{"en": "Rubber Ducks"}', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 1, '', '{"en": "Subcategory"}', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
(1, '', 1, 'user@email.com', '0000000000', 'ACME Corp.', 'John', 'Doe', 'Longway Street 1', '', '12345', 'Newtown', 'US', 'CA', '1-555-123-4567', 0, '', '', '', '', '', '', '', '', '', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_modules` (`module_id`, `type`, `status`, `priority`, `settings`, `last_log`, `updated_at`, `created_at`) VALUES
('sm_zone_weight', 'shipping', 0, 0, '{"status":"1","icon":"","weight_unit":"kg","geo_zone_id_1":"","weight_rate_table_1":"","geo_zone_id_2":"","weight_rate_table_2":"","geo_zone_id_3":"","weight_rate_table_3":"","weight_rate_table_x":"5:8.95;10:15.95","method":">=","handling_fee":"0.00","tax_class_id":"1","priority":"0"}', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('pm_cod', 'payment', 0, 0, '{"status":"1","icon":"","fee":"5.00","tax_class_id":"1","order_status_id":"2","geo_zone_id":"","priority":"0"}', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_orders` (`id`, `no`, `order_status_id`, `customer_id`, `customer_company`, `customer_firstname`, `customer_lastname`, `customer_email`, `customer_phone`, `customer_tax_id`, `customer_address1`, `customer_address2`, `customer_city`, `customer_postcode`, `customer_country_code`, `customer_zone_code`, `shipping_company`, `shipping_firstname`, `shipping_lastname`, `shipping_address1`, `shipping_address2`, `shipping_city`, `shipping_postcode`, `shipping_country_code`, `shipping_zone_code`, `shipping_phone`, `shipping_option_id`, `shipping_option_name`, `shipping_tracking_id`, `payment_option_id`, `payment_option_name`, `payment_transaction_id`, `language_code`, `weight_total`, `weight_unit`, `currency_code`, `currency_value`, `subtotal`, `subtotal_tax`, `total`, `total_tax`, `updated_at`, `created_at`) VALUES
(1, 1, 2, 1, 'ACME Corp.', 'John', 'Doe', 'user@email.com', '1-555-123-4567', '', 'Longway Street 1', '', 'Newtown', '12345', 'US', 'CA', 'ACME Corp.', 'John', 'Doe', 'Longway Street 1', '', 'Newtown', '12345', 'US', 'CA', '', 'sm_vendor:parcel', 'Domestic Parcel', '1112223334', 'pm_vendor:card', 'Card Payment', '123456789', 'en', '1.00', 'kg', 'USD', 1, 8, 0, 7.2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_orders_comments` (`id`, `order_id`, `author`, `text`, `hidden`, `created_at`) VALUES
(1, 1, 'customer', 'This is a message from the customer.', 0, CURRENT_TIMESTAMP),
(2, 1, 'staff', 'This is a message from the store crew.', 0, CURRENT_TIMESTAMP),
...
-- -----
INSERT INTO `lc_products` (`id`, `status`, `brand_id`, `supplier_id`, `delivery_status_id`, `sold_out_status_id`, `default_category_id`, `code`, `name`, `quantity_unit_id`, `tax_class_id`, `image`, `valid_from`, `valid_to`, `updated_at`, `created_at`) VALUES
(1, 1, 1, 0, 1, 2, 2, 'rd001', '{"en": "Yellow Duck"}', 1, 1, 'products/1-yellow-duck-1.webp', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 1, 0, 1, 2, 2, 'rd002', '{"en": "Green Duck"}', 1, 1, 'products/2-green-duck-1.webp', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 1, 1, 0, 1, 2, 1, 'rd003', '{"en": "Red Duck"}', 1, 1, 'products/3-red-duck-1.webp', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 1, 1, 0, 1, 2, 1, 'rd004', '{"en": "Blue Duck"}', 1, 1, 'products/4-blue-duck-1.webp', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 1, 0, 1, 2, 1, 'rd005', '{"en": "Purple Duck"}', 1, 1, 'products/5-purple-duck-1.webp', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
(1, 1, 'RD001-S', '4006381333931', '{"en": "Yellow Duck (Small)"}', 'stock_items/1-yellow-duck-small.webp', 1.0000, 'kg', 10.0000, 10.0000, 10.0000, 'cm', 50.0000, 0.0000, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 'RD001-M', '4006381333932', '{"en": "Yellow Duck (Medium)"}', 'stock_items/2-yellow-duck-medium.webp', 1.0000, 'kg', 12.0000, 12.0000, 12.0000, 'cm', 50.0000, 0.0000, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 1, 'RD001-L', '4006381333933', '{"en": "Yellow Duck (Large)"}', 'stock_items/3-yellow-duck-large.webp', 1.0000, 'kg', 15.0000, 15.0000, 15.0000, 'cm', 0.0000, 50.0000, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
