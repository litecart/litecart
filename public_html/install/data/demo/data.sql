...
-- --------------------------------------------------------
INSERT INTO `lc_products` (`id`, `status`, `manufacturer_id`, `supplier_id`, `delivery_status_id`, `sold_out_status_id`, `default_category_id`, `product_groups`, `keywords`, `code`, `sku`, `upc`, `taric`, `quantity`, `quantity_unit_id`, `weight`, `weight_class`, `dim_x`, `dim_y`, `dim_z`, `dim_class`, `purchase_price`, `tax_class_id`, `image`, `views`, `purchases`, `date_valid_from`, `date_valid_to`, `date_updated`, `date_created`) VALUES
(1, 1, 1, 0, 1, 2, 2, '', '', 'rd001', 'RD001', '', '', 30, 1, 0.5000, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10.0000, 1, 'products/1-yellow-duck-1.png', 1, 0, '0000-00-00', '0000-00-00', NOW(), NOW()),
(2, 1, 1, 0, 1, 2, 2, '', '', 'rd002', 'RD002', '', '', 30, 1, 0.5000, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10.0000, 1, 'products/2-green-duck-1.png', 1, 0, '0000-00-00', '0000-00-00', NOW(), NOW()),
(3, 1, 1, 0, 1, 2, 1, '', '', 'rd003', 'RD003', '', '', 30, 1, 0.5000, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10.0000, 1, 'products/3-red-duck-1.png', 1, 0, '0000-00-00', '0000-00-00', NOW(), NOW()),
(4, 1, 1, 0, 1, 2, 1, '', '', 'rd004', 'RD004', '', '', 30, 1, 0.5000, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10.0000, 1, 'products/4-blue-duck-1.png', 1, 0, '0000-00-00', '0000-00-00', NOW(), NOW());
-- --------------------------------------------------------
