...
-- --------------------------------------------------------
INSERT INTO `lc_orders_items` (`id`, `order_id`, `product_id`, `option_stock_combination`, `options`, `name`, `sku`, `quantity`, `price`, `tax`, `weight`, `weight_unit`) VALUES
...
-- --------------------------------------------------------
INSERT INTO `lc_products` (`id`, `status`, `brand_id`, `supplier_id`, `delivery_status_id`, `sold_out_status_id`, `default_category_id`, `keywords`, `code`, `sku`, `mpn`, `gtin`, `taric`, `quantity`, `quantity_unit_id`, `weight`, `weight_unit`, `length`, `width`, `height`, `length_unit`, `purchase_price`, `tax_class_id`, `image`, `views`, `purchases`, `date_valid_from`, `date_valid_to`, `date_updated`, `date_created`) VALUES
...
-- --------------------------------------------------------
INSERT INTO `lc_products_stock_options` (`id`, `product_id`, `stock_item_id`, `sku`, `weight`, `weight_unit`, `length`, `width`, `height`, `length_unit`, `quantity`, `priority`, `date_updated`, `date_created`) VALUES
(1, 1, 1, 'RD001-S', 1.0, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10, 0, NOW(), NOW()),
(2, 1, 2, 'RD001-M', 1.1, 'kg', 8.0000, 12.5000, 12.5000, 'cm', 10, 1, NOW(), NOW()),
(3, 1, 3, 'RD001-L', 1.2, 'kg', 10.0000, 15.0000, 15.0000, 'cm', 10, 2, NOW(), NOW());
-- --------------------------------------------------------
