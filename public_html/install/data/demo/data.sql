...
(1, 2, 1, 'ACME Corp.', 'John', 'Doe', 'user@email.com', '1-555-123-4567', '', 'Longway Street 1', '', 'Newtown', '12345', 'US', 'CA', 'ACME Corp.', 'John', 'Doe', 'Longway Street 1', '', 'Newtown', '12345', 'US', 'CA', '', 'sm_vendor:parcel', 'Domestic Parcel', '1112223334', 'pm_vendor:card', 'Card Payment', '123456789', 'en', '1.00', 'kg', 'USD', 1, 8, 0, 7.2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
-- -----
INSERT INTO `lc_orders_lines` (`id`, `order_id`, `product_id`, `userdata`, `name`, `sku`, `gtin`, `quantity`, `price`, `tax`, `weight`, `weight_unit`) VALUES
(1, 1, 1, '', 'Yellow Duck', 'RD001-S', '4006381333931', 1, 8.00, 0, 1.00, 'kg');
-- -----
