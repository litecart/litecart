...
-- --------------------------------------------------------
INSERT INTO `lc_products_stock_options` (`id`, `product_id`, `stock_item_id`, `sku`, `weight`, `weight_unit`, `length`, `width`, `height`, `length_unit`, `quantity`, `priority`) VALUES
(1, 1, 1, 'RD001-S', 1.0, 'kg', 6.0000, 10.0000, 10.0000, 'cm', 10, 0),
(2, 1, 2, 'RD001-M', 1.1, 'kg', 8.0000, 12.5000, 12.5000, 'cm', 10, 1),
(3, 1, 3, 'RD001-L', 1.2, 'kg', 10.0000, 15.0000, 15.0000, 'cm', 10, 2);
-- --------------------------------------------------------
