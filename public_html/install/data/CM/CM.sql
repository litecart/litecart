...
('1', 'XAF', '950', 'Central African CFA Franc', '1.00000000', '0', '', ' FCFA', '1', NOW());
-- -----
...
('CM_VAT', 'CM VAT Zone', 'Cameroon', NOW(), NOW());
-- -----
...
('CM_VAT', 'Cameroon VAT', 'Standard 19.25% VAT rate', NOW(), NOW());
-- -----
...
(@TAX_CLASS_ID, @VAT_ZONE_ID, 'percent', 'Cameroon VAT', '19.25%', '19.25000', NOW(), NOW());