...
(1, 'tr', 'tur', 'Türkçe', 'tr_TR.utf8,tr_TR.UTF-8,turkish', 'tr_TR', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', '.', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
ALTER TABLE `lc_translations` ADD `text_tr` text NOT NULL AFTER `text_en`;
-- -----
INSERT INTO `lc_currencies` (`status`, `code`, `number`, `name`, `value`, `decimals`, `prefix`, `suffix`, `priority`, `updated_at`, `created_at`) VALUES
(', 'Türk Lirası', 1.00, 2, '₺', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
ALTER TABLE `lc_products_prices` ADD `TRY` DECIMAL(11,4) NOT NULL;
-- -----
...
('Standard (KDV)', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Reduced (KDV)', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Super Reduced (KDV)', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
