...
(1, 'sl', 'slv', 'Slovenščina', 'sl_SI.utf8,sl_SI.UTF-8,slovenian', 'sl_SI', 'Y-m-d', 'H:i', 'Y-m-d H:i', '%b %e %Y', '%H:%M', '%b %e %Y %H:%M', ',', ' ', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
ALTER TABLE `lc_translations` ADD `text_sl` text NOT NULL AFTER `text_en`;
-- -----
...
('SI VAT Zone', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
SET @SI_VAT_ZONE = LAST_INSERT_ID();
-- -----
INSERT INTO `lc_zones_to_geo_zones` (`geo_zone_id`, `country_code`, `zone_code`, `updated_at`, `created_at`) VALUES
(@SI_VAT_ZONE, 'SI', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
INSERT INTO `lc_geo_zones` (`name`, `description`, `updated_at`, `created_at`) VALUES
('EU VAT Zone', 'European Union excl. SI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
(1, @SI_VAT_ZONE, 'SI VAT 22%', '', 22.0000, 1, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, @EU_VAT_ZONE, 'SI VAT 22%', '', 22.0000, 0, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, @SI_VAT_ZONE, 'SI VAT 9,5%', '', 9.5000, 1, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, @EU_VAT_ZONE, 'SI VAT 9,5%', '', 9.5000, 0, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);