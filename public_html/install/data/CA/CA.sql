...
('CA Tax Zone', 'Tax zone for Canada', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
(@CA_VAT_ZONE, 'CA', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
...
(1, @CA_VAT_ZONE, 'Tax 13%', '', 13, 1, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- -----
UPDATE `lc_settings`
SET `value` = 'US-Letter'
