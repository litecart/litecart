<?php
  ...
  $box_similar_products_cache_token = cache::token('box_similar_products', [$_GET['product_id'], isset($_GET['category_id']) ? $_GET['category_id'] : array_keys($product->categories), 'language', 'currency'], 'file');
