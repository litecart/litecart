<?php
	...
	$box_account->snippets['menu_items'][] = [
		'title' => t('title_regional_settings', 'Regional Settings'),
	...
	if (customer::check_login()) {
		...
		$box_account->snippets['menu_items'][] = [
			'title' => t('title_edit_account', 'Edit Account'),
