<?php
	...
	if (!$box_also_purchased_products->snippets['products'] = cache::get($box_also_purchased_products_cache_token)) {
		...
		cache::set($box_also_purchased_products_cache_token, $box_also_purchased_products->snippets['products']);
	}
