	...
	<div class="grid">
		...
		<div class="col-md-9">
			<div id="content">
				...
				<div class="grid">
				<section id="box-login" class="card col-md-6" style="margin-bottom: 0;" aria-label="<?php echo f::escape_attr(t('title_sign_in', 'Sign In')); ?>">
					...
					<div class="card-body">
						<?php echo f::form_begin('sign_in_form', 'post', document::ilink('account/sign_in'), false, ['aria-label' => f::escape_attr(t('title_sign_in', 'Sign In'))]); ?>
							...
							<div class="text-center">
								<a href="<?php echo document::ilink('account/reset_password', ['email' => $_POST['email'] ?? '']); ?>">
				...
				<section id="box-login-create" class="card col-md-6" style="margin-bottom: 0;" aria-label="<?php echo f::escape_attr(t('title_sign_up', 'Sign Up')); ?>">
					<div class="card-header">
