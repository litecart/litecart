...
<section id="box-checkout-summary">
  ...
  <div class="comments form-group">
    ...
    <?php echo functions::form_input_textarea('comments', true, 'maxlength="250" rows="2"'); ?>
...
<script>
  ...
  $('form[name="checkout_form"]').submit(function(e) {
    let new_button = '<div class="btn btn-block btn-default btn-lg disabled"><?php echo functions::draw_fonticon('fa-spinner'); ?> <?php echo functions::escape_js(language::translate('text_please_wait', 'Please wait')); ?>&hellip;</div>';
