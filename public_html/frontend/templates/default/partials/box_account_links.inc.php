<section id="box-account">
	...
	<nav class="nav nav-stacked nav-pills">
		...
		<a class="nav-item<?php if (route::$selected['route'] == 'f:addresses') echo ' active'; ?>" href="<?php echo document::href_ilink('account/addresses'); ?>"><?php echo language::translate('title_addresses', 'Addresses'); ?></a>
