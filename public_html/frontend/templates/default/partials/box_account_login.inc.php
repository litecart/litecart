<section id="box-account-sign-in" class="card" aria-label="<?php echo f::escape_attr(t('title_sign_in', 'Sign In')); ?>">
	...
	<div class="card-body">
		<?php echo f::form_begin('sign_in_form', 'post', document::ilink('account/sign_in'), false, ['aria-label' => f::escape_attr(t('title_sign_in', 'Sign In'))]); ?>
			<?php echo f::form_input_hidden('redirect_url', $_GET['redirect_url'] ?? document::ilink('')); ?>
