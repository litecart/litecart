...
<section id="box-category-tree" class="hidden-xs">
  ...
  <ul class="nav nav-stacked nav-pills">
    <li><a class="nav-link" href="<?php echo functions::escape_html($backlink); ?>"><?php echo functions::draw_fonticon('fa-angle-left fa-fw'); ?> <?php echo language::translate('title_back', 'Back'); ?></a></li>
