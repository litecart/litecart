					...
					<div class="grid">
						...
						<div class="col-sm-4">
							<div style="display: inline-flex;">
								...
								<?php echo functions::form_button('update_cart_item', array($key, functions::draw_fonticon('icon-sync')), 'submit', 'title="'. functions::escape_attr(language::translate('title_update', 'Update')) .'" formnovalidate style="margin-inline-start: 0.5em;"'); ?>
