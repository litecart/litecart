<section id="box-account-sign_in" class="card">
	...
	<div class="card-body">
		<?php echo functions::form_begin('sign_in_form', 'post', document::ilink('account/sign_in')); ?>
			...
			<p class="text-center">
				<a href="<?php echo document::href_ilink('account/sign_up'); ?>"><?php echo language::translate('text_new_customers_click_here', 'New customers click here'); ?></a>
			</p>

			<p class="text-center">
				<a href="<?php echo document::href_ilink('account/reset_password'); ?>"><?php echo language::translate('text_lost_your_password', 'Lost your password?'); ?></a>
			</p>
