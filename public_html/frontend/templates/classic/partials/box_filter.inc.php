	...
	<?php echo functions::form_begin('filter_form', 'get'); ?>
		...
		<div class="filters">
			...
			<div class="btn-group btn-group-inline" data-toggle="buttons" style="flex-grow: 0;">
				<label class="btn btn-default<?php echo ($_GET['list_style'] == 'columns') ? ' active' : ''; ?>"><input type="radio" name="list_style" value="columns"<?php echo (!isset($_GET['list_style']) || $_GET['list_style'] == 'columns') ? ' checked' : ''; ?>><?php echo functions::draw_fonticon('icon-th'); ?></label>
				<label class="btn btn-default<?php echo ($_GET['list_style'] == 'rows') ? ' active' : ''; ?>"><input type="radio" name="list_style" value="rows"<?php echo (isset($_GET['list_style']) && $_GET['list_style'] == 'rows') ? ' checked' : ''; ?>><?php echo functions::draw_fonticon('icon-th-list'); ?></label>
			</div>
		</div>
