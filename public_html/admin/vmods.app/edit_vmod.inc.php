  ...
  <div class="panel-body">
    <?php echo functions::form_draw_form_begin('vmod_form', 'post', false, true); ?>
      ...
      <div class="panel-action btn-group">
        ...
        <?php echo (isset($vmod->data['id'])) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
      </div>
