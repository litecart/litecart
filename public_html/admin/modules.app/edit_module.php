...
<h1 style="margin-top: 0;"><img src="<?php echo WS_DIR_ADMIN . $_GET['app'] .'.app/icon.png'; ?>" width="32" height="32" border="0" align="absmiddle" style="margin-right: 10px;" /><?php echo $system->language->translate('title_edit_module', 'Edit Module'); ?></h1>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="ListTable">
<?php
...
?>
  <tr class="<?=$rowclass?>-Hover">
    <td align="left" valign="top"><strong><?=$setting['title']?></strong><? echo !empty($setting['description']) ? '<br />' . $setting['description'] : false; ?><br />
