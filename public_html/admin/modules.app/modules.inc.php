...
?>
  <tr class="<?php echo $rowclass . (!empty($module->status) ? false : ' semi-transparent'); ?>">
    ...
    <td nowrap="nowrap" align="center"><a href="<?php echo $system->document->href_link('', array('doc' => 'run_job', 'module_id' => $module->id), array('app')); ?>"><strong><?php echo $system->language->translate('title_run_now', 'Run Now'); ?></strong></a></td>
    <?php } else { ?>
...
?>
  <tr class="footer">
    <td colspan="8" align="left"><?php echo $system->language->translate('title_modules', 'Modules'); ?>: <?php echo $num_module_rows; ?></td>
  </tr>
</table>
