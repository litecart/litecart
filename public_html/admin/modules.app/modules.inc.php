      ...
      <table class="table table-striped table-hover data-table">
        ...
        <tbody>
          ...
          <tr class="<?php echo empty($module['status']) ? 'semi-transparent' : null; ?>">
            ...
            <td class="text-right"><a href="<?php echo document::href_link('', ['doc' => $edit_doc, 'module_id' => $module['id']], true); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('fa-pencil'); ?></a></td>
          </tr>
          <?php } else { ?>
          <tr class="semi-transparent">
            ...
            <td><?php echo $module['id']; ?></td>
            <td style="text-align: center;">-</td>
            <td style="text-align: right;"><a href="<?php echo document::href_link('', ['doc' => 'edit_'.$type, 'module_id' => $module['id']], true); ?>"><?php echo functions::draw_fonticon('fa-plus-circle', 'style="color: #66cc66;"'); ?> <?php echo language::translate('title_install', 'Install'); ?></a></td>
          </tr>
          <?php } ?>
          <?php } ?>
        </tbody>
