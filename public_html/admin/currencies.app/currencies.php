...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_currency.php'), true), $system->language->translate('title_add_new_currency', 'Add New Currency'), '', 'add'); ?></div>
