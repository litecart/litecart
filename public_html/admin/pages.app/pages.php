...
?>
<div style="float: right;"><a class="button" href="<?php echo $system->document->href_link('', array('doc' => 'edit_page.php'), true); ?>"><?php echo $system->language->translate('title_create_new_page', 'Create New Page'); ?></a></div>
<h1 style="margin-top: 0px;"><img src="<?php echo WS_DIR_ADMIN . $_GET['app'] .'.app/icon.png'; ?>" width="32" height="32" style="vertical-align: middle;" style="margin-right: 10px;" /><?php echo $system->language->translate('title_pages', 'Pages'); ?></h1>
...
?>
  <tr class="<?php echo $rowclass . ($page['status'] ? false : ' semi-transparent'); ?>">
    ...
    <td align="center" nowrap="nowrap"><?php echo !empty($page['dock_menu']) ? 'x' : ''; ?></td>
    <td align="center" nowrap="nowrap"><?php echo !empty($page['dock_support']) ? 'x' : ''; ?></td>
    <td align="right"><a href="<?php echo $system->document->href_link('', array('doc' => 'edit_page.php', 'pages_id' => $page['id']), true); ?>"><img src="<?php echo WS_DIR_IMAGES . 'icons/16x16/edit.png'; ?>" width="16" height="16" title="<?php echo $system->language->translate('title_edit', 'Edit'); ?>" /></a></td>
  </tr>
<?php
