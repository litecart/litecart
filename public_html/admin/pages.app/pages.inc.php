...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_page'), true), $system->language->translate('title_create_new_page', 'Create New Page'), '', 'add'); ?></div>
