...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_order.php'), true), $system->language->translate('title_create_new_order', 'Create New Order'), '', 'add'); ?></div>
