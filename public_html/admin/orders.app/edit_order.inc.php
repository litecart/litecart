...
?>
  ...
  <tr class="footer" style="font-size: 1.5em;">
    <td colspan="6" nowrap="nowrap" align="right"><?php echo $system->language->translate('title_payment_due', 'Payment Due'); ?>: <strong id="order-total"><?php echo $system->currency->format($order->data['payment_due'], false, false, $order->data['currency_code'], $order->data['currency_value']); ?></strong></td>
  </tr>
</table>
<script>
