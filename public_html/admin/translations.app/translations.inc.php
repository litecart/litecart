      ...
      foreach ($_POST['translations'] as $translation) {
        ...
        if ($translation['entity'] == 'translation') {
          database::query(
            ...
            set html = ". (int)$translation['html'] .",
              ". implode(', ' . PHP_EOL, array_map(function($language_code) use($translation) { return "text_$language_code = '". database::input($translation['text_'.$language_code], !empty($translation['html'])) .'"'; }, $_GET['languages'])) .",
