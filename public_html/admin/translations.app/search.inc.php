    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php } ?>
          <td class="text-end"><a class="btn btn-default btn-sm delete" href="#" title="<?php echo language::translate('title_remove', 'Remove'); ?>"><?php echo functions::draw_fonticon('remove'); ?></a></td>
        </tr>
        <?php } ?>
      </tbody>
