...
?>
<h1 style="margin-top: 0px;"><img src="<?php echo WS_DIR_ADMIN . $_GET['app'] .'.app/icon.png'; ?>" width="32" height="32" border="0" align="absmiddle" style="margin-right: 10px;" /><?php echo (isset($language->data['id'])) ? $system->language->translate('title_edit_language', 'Edit Language') : $system->language->translate('title_add_new_language', 'Add New Language'); ?></h1>
...
<?php echo $system->functions->form_draw_form_begin('', 'post'); ?>
  <table border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_code', 'Code'); ?> (ISO 639-1)</strong><br />
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_charset', 'Charset'); ?></strong><br />
        <?php echo $system->functions->form_draw_input_field('charset', isset($_POST['charset']) ? $_POST['charset'] : '', 'text', 'style="width: 75px;"'); ?>
      </td>
    </tr>
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_system_locale', 'System Locale'); ?></strong><br />
        <?php echo $system->functions->form_draw_input_field('locale', isset($_POST['locale']) ? $_POST['locale'] : '', 'text', 'style="width: 75px;"'); ?>
      </td>
    </tr>
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_date_format', 'Date Format'); ?></strong> (<a href="http://php.net/manual/en/function.strftime.php" target="_blank">?</a>)<br />
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_time_format', 'Time Format'); ?></strong> (<a href="http://php.net/manual/en/function.strftime.php" target="_blank">?</a>)<br />
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_raw_date_format', 'Raw Date Format'); ?></strong> (<a href="http://php.net/manual/en/function.date.php" target="_blank">?</a>)<br />
        <?php echo $system->functions->form_draw_input_field('raw_date', isset($_POST['raw_date']) ? $_POST['raw_date'] : '', 'text', 'style="width: 75px;"'); ?>
      </td>
    </tr>
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_raw_time_format', 'Raw Time Format'); ?></strong> (<a href="http://php.net/manual/en/function.date.php" target="_blank">?</a>)<br />
        <?php echo $system->functions->form_draw_input_field('raw_time', isset($_POST['raw_time']) ? $_POST['raw_time'] : '', 'text', 'style="width: 75px;"'); ?>
      </td>
    </tr>
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_decimal_point', 'Decimal Point'); ?></strong><br />
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><strong><?php echo $system->language->translate('title_thousands_sep', 'Thousands Separator'); ?></strong><br />
    ...
    <tr>
      <td align="left" valign="top" nowrap="nowrap"><?php echo $system->functions->form_draw_button('save', $system->language->translate('title_save', 'Save'), 'submit'); ?> <?php echo $system->functions->form_draw_button('cancel', $system->language->translate('title_cancel', 'Cancel'), 'button', 'onclick="history.go(-1);"'); ?> <?php echo (isset($language->data['id'])) ? $system->functions->form_draw_button('delete', $system->language->translate('title_delete', 'Delete'), 'submit', 'onclick="if (!confirm(\''. $system->language->translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"') : false; ?></td>
    </tr>
  </table>
