...
<div class="row">
  <div class="col-md-6">
    ...
    <fieldset>
      ...
      <div class="row">
        <div class="col-md"><?php echo functions::form_draw_button('import', language::translate('title_import', 'Import'), 'submit'); ?></div>
      </div>
  ...
  <div class="col-md-6">
    ...
    <fieldset>
      ...
      <?php echo functions::form_draw_form_begin('export_form', 'post'); ?>
        ...
        <div class="row">
          <div class="col-md"><?php echo functions::form_draw_button('export', language::translate('title_export', 'Export'), 'submit'); ?></div>
        </div>
