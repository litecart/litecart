      ...
      <div class="row" style="max-width: 960px;">
        ...
        <div class="col-md-8">
          ...
          <div class="card-action">
            ...
            <?php echo !empty($customer->data['id']) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!window.confirm(\\"'. language::translate('text_are_you_sure', 'Are you sure?') .'\\")) return false;"', 'delete') : ''; ?>
