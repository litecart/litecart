...
<div class="panel panel-app">
  <div class="panel-heading">
    <?php echo $app_icon; ?> <?php echo !empty($option_group->data['id']) ? language::translate('title_edit_option_group', 'Edit Option Group') : language::translate('title_create_new_option_group', 'Create New Option Group'); ?>
  </div>
    ...
    <?php echo functions::form_draw_form_begin('option_group_form', 'post', false, false, 'style="max-width: 640px;"'); ?>
      ...
      <div id="option-values-multiset">
        ...
        <table class="table table-striped table-dragable table-hover data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <a href="#"<?php echo empty($num_products) ? ' class="remove"' : ''; ?> title="<?php echo language::translate('title_remove', 'Remove'); ?>"><?php echo functions::draw_fonticon('remove'); ?></a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
          <tfoot>
            <tr>
              <td colspan="3"><a class="add" href="#"><?php echo functions::draw_fonticon('add'); ?> <?php echo language::translate('title_add_value', 'Add Value'); ?></a></td>
            </tr>
          </tfoot>
        </table>
      </div>
