<div style="float: right;"><a class="button" href="<?php echo $system->document->link('', array('doc'=> 'edit_product_group.php'), array('app')); ?>"><?php echo $system->language->translate('title_create_new_product_group', 'Create New Product Group'); ?></a></div>
...
?>
  <tr class="<?php echo $rowclass; ?>">
    ...
    <td><a href="<?php echo $system->document->link('', array('doc' => 'edit_product_group.php', 'product_group_id' => $product_group['id']), true); ?>"><img src="<?php echo WS_DIR_IMAGES .'icons/16x16/edit.png'; ?>" width="16" height="16" border="0" align="absbottom" /></a></td>
  </tr>
<?php
  }
?>
