...
?>
<div style="float: right;"><a class="button" href="<?php echo $system->document->link('', array('doc' => 'edit_sold_out_status.php'), true); ?>"><?php echo $system->language->translate('title_create_new_sold_out_status', 'Create New Sold Out Status'); ?></a></div>
<h1 style="margin-top: 0px;"><img src="<?php echo WS_DIR_ADMIN . $_GET['app'] .'.app/icon.png'; ?>" width="32" height="32" border="0" align="absmiddle" style="margin-right: 10px;" /><?php echo $system->language->translate('title_sold_out_statuses', 'Sold Out Statuses'); ?></h1>
...
<?php
  ...
  // Jump to data for current page
    if ($_GET['page'] > 1) $system->database->seek($sold_out_status_query, ($system->settings->get('data_table_rows_per_page', 20) * ($_GET['page']-1)));
...
?>
  <tr class="<?php echo $rowclass; ?>">
    ...
    <td align="left" valign="top"><?php echo $sold_out_status['id']; ?></td>
    <td align="left" valign="top" nowrap="nowrap"><?php echo $sold_out_status['name']; ?></td>
    <td align="center" valign="top" nowrap="nowrap"><?php echo !empty($sold_out_status['orderable']) ? 'x' : ''; ?></td>
    <td align="right"><a href="<?php echo $system->document->link('', array('doc' => 'edit_sold_out_status.php', 'sold_out_status_id' => $sold_out_status['id']), true); ?>"><img src="<?php echo WS_DIR_IMAGES . 'icons/16x16/edit.png'; ?>" width="16" height="16" border="0" title="<?php echo $system->language->translate('title_edit', 'Edit'); ?>" /></a></td>
  </tr>
<?php
...
<?php
  ...
  echo $system->functions->draw_pagination(ceil($system->database->num_rows($sold_out_status_query)/$system->settings->get('data_table_rows_per_page', 20)));
?>