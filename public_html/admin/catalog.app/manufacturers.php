...
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('app' => $_GET['app'], 'doc' => 'edit_manufacturer.php')), $system->language->translate('title_add_new_manufacturer', 'Add New Manufacturer'), '', 'add'); ?></div>
