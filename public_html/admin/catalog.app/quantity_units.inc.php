...
// Table Rows
  ...
  $quantity_units_query = database::query(
    "select qu.id, qui.name, qui.description from ". DB_PREFIX ."quantity_units qu
    left join ". DB_PREFIX ."quantity_units_info qui on (qu.id = qui.quantity_unit_id and qui.language_code = '". language::$selected['code'] ."')
