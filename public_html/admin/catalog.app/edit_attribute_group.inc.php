...
?>
        <tr>
          ...
          <td class="text-right"><?php echo empty($num_products) ? '<a href="#" class="remove" title="'. language::translate('title_remove', 'Remove') .'">'. functions::draw_fonticon('remove') .'</a>' : false; ?></td>
        </tr>
  <?php
    }
  ?>
      ...
      <tfoot>
        <tr>
          <td colspan="4"><a class="add" href="#"><?php echo functions::draw_fonticon('add'); ?> <?php echo language::translate('title_add_group', 'Add Group Value'); ?></a></td>
        </tr>
      </tfoot>
    </table>
