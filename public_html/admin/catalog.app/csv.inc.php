    ...
    if (empty(notices::$data['errors'])) {
      ...
      while ($category = database::fetch($categories_query)) {
        ...
        $csv[] = array(
          ...
          'meta_description' => $category->meta_description[$_POST['language_code']],
          'head_title' => $category->head_title[$_POST['language_code']],
          'h1_title' => $category->h1_title[$_POST['language_code']],
