...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_delivery_status'), true), $system->language->translate('title_create_new_status', 'Create New Status'), '', 'add'); ?></div>
