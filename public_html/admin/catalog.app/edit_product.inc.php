            ...
            <fieldset style="max-width: 960px;">
              ...
              <div class="row" style="margin-bottom: 0;">
                <div class="form-group col-md-3">
                  <label><?php echo language::translate('title_group', 'Group'); ?></label>
...
// Options
  ...
  $('body').on('click', '.featherlight button[name="add_predefined_option"]', function(e) {
    ...
    if (!$('#tab-options input[name^="options"][name$="[group_id]"][value="'+ $(groupElement).val() +'"]').length) {
      var output = '<li>'
                 ...
                 + '  <?php echo functions::general_escape_js(functions::form_draw_hidden_field('options[new_option_group_i][group_id]', 'new_group_id')); ?>'
                 + '  <div class="row">'
                 + '    <div class="form-group col-sm-4 col-md-2">'
                 + '      <label><?php echo language::translate('title_function', 'Function'); ?></label>'
                 + '      <?php echo functions::general_escape_js(functions::form_draw_select_field('options[new_option_group_i][function]', array('select', 'radio', 'checkbox'), 'select')); ?>'
                 + '    </div>'
                 + '    <div class="form-group col-sm-4 col-md-2">'
                 + '      <label><?php echo language::translate('title_required', 'Required'); ?></label>'
                 + '      <div class="checkbox">'
                 + '        <label><?php echo functions::form_draw_checkbox('options[new_option_group_i][required]', '1', true); ?> <?php echo language::translate('title_required', 'Required'); ?></label>'
                 + '      </div>'
                 + '    </div>'
                 + '    <div class="form-group col-sm-4 col-md-2">'
                 + '      <label><?php echo language::translate('title_sort_values', 'Sort Values'); ?></label>'
                 + '      <?php echo functions::general_escape_js(functions::form_draw_select_field('options[new_option_group_i][sort]', $option_sort_options, 'custom')); ?>'
                 + '    </div>'
                 + '  </div>'
                 + '  <div class="table-responsive">'
                 + '    <table id="table-options" class="table table-striped table-hover table-dragable data-table">'
  ...
  $('body').on('click', '.featherlight button[name="add_user_input_option"]', function(e) {
    ...
    var output = '<li>'
               ...
               + '    <div class="form-group col-sm-4 col-md-2">'
               + '      <label><?php echo language::translate('title_function', 'Function'); ?></label>'
               + '      <?php echo functions::general_escape_js(functions::form_draw_select_field('options[new_option_group_i][function]', array('input', 'textarea'), 'input')); ?>'
               + '    </div>'
               + '    <div class="form-group col-sm-4 col-md-2">'
               + '      <label><?php echo language::translate('title_required', 'Required'); ?></label>'
               + '      <div class="checkbox">'
