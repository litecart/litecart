...
<p>
  <ul class="list-horizontal">
    ...
    <li><?php echo functions::form_draw_categories_list('category_id', true); ?> <?php echo functions::form_draw_button('move', language::translate('title_move', 'Move'), 'submit', 'onclick="if (!confirm(\''. str_replace("'", "\\\'", language::translate('warning_multiple_references_will_be_lost', 'Warning: Multiple references will be lost.')) .'\')) return false;"'); ?> <?php echo functions::form_draw_button('copy', language::translate('title_copy', 'Copy'), 'submit'); ?></li>
