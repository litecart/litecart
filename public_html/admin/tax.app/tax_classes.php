...
?>
<div style="float: right;"><a class="button" href="<?php echo $system->document->link('', array('doc' => 'edit_tax_class.php'), true); ?>"><?php echo $system->language->translate('title_add_new_tax_class', 'Add New Tax Class'); ?></a></div>
<h1 style="margin-top: 0px;"><img src="<?php echo WS_DIR_ADMIN . $_GET['app'] .'.app/icon.png'; ?>" width="32" height="32" border="0" align="absmiddle" style="margin-right: 10px;" /><?php echo $system->language->translate('title_tax_classs', 'Tax Classes'); ?></h1>
...
?>
  <tr class="<?php echo $rowclass; ?>">
    ...
    <td align="left" valign="top"><?php echo $tax_class['id']; ?></td>
    <td align="left" valign="top" nowrap="nowrap"><?php echo $tax_class['name']; ?></td>
    <td align="left" valign="top" style="color: #999;"><?php echo $tax_class['description']; ?></td>
    <td align="right"><a href="<?php echo $system->document->link('', array('doc' => 'edit_tax_class.php', 'tax_class_id' => $tax_class['id']), true); ?>"><img src="<?php echo WS_DIR_IMAGES . 'icons/16x16/edit.png'; ?>" width="16" height="16" border="0" title="<?php echo $system->language->translate('title_edit', 'Edit'); ?>" /></a></td>
  </tr>
<?php
