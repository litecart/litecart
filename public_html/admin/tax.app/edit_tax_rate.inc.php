        ...
        <table>
          ...
          <tr>
            <td align="left" nowrap="nowrap"><strong><?php echo language::translate('title_rule', 'Rule'); ?>: <?php echo language::translate('title_customer_type', 'Customer Type'); ?></strong><br />
              ...
              <?php echo functions::form_draw_radio_button('customer_type', 'both', true); ?> <?php echo language::translate('text_tax_rate_rule_both_of_the_above', 'Applies to both of above'); ?>
            </td>
          </tr>
          <tr>
            <td align="left" nowrap="nowrap"><strong><?php echo language::translate('title_rule', 'Rule'); ?>: <?php echo language::translate('title_tax_id', 'Tax ID'); ?></strong><br />
              ...
              <?php echo functions::form_draw_radio_button('tax_id_rule', 'both', true); ?> <?php echo language::translate('text_tax_rate_rule_both_of_the_above', 'Applies to both of above'); ?>
            </td>
          </tr>
          <tr>
