...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_tax_class'), true), $system->language->translate('title_add_new_tax_class', 'Add New Tax Class'), '', 'add'); ?></div>
