...
?>
<div style="float: right;"><?php echo $system->functions->form_draw_link_button($system->document->link('', array('doc' => 'edit_country'), true), $system->language->translate('title_add_new_country', 'Add New Country'), '', 'add'); ?></div>
