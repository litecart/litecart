  ...
  <div class="box" id="box-customer-service">
    ...
    <div class="content">
      ...
      <table>
        ...
        <tr>
          <td colspan="2"><?php echo language::translate('title_subject', 'Subject'); ?><br />
            <?php echo functions::form_draw_text_field('subject', true, 'data-size="large"'); ?></td>
        </tr>
        <tr>
          <td colspan="2"><?php echo language::translate('title_message', 'Message'); ?><br />
        ...
        <tr>
          <td colspan="2"><?php echo language::translate('title_captcha', 'CAPTCHA'); ?><br />
