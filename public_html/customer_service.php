...
?>
  ...
  <div class="box" id="box-customer-service">
    ...
    <div class="content">
      ...
      <table>
        <tr>
          <td><?php echo $system->language->translate('title_name', 'Name'); ?> <span class="required">*</span><br />
            <?php echo $system->functions->form_draw_text_field('name', true); ?></td>
          <td><?php echo $system->language->translate('title_email_address', 'E-mail Address'); ?> <span class="required">*</span><br />
            <?php echo $system->functions->form_draw_email_field('email', true, ''); ?></td>
        </tr>
        <tr>
          <td colspan="2"><?php echo $system->language->translate('title_subject', 'Subject'); ?> <span class="required">*</span><br />
            <?php echo $system->functions->form_draw_text_field('subject', true, 'data-size="large"'); ?></td>
        </tr>
        <tr>
          <td colspan="2"><?php echo $system->language->translate('title_message', 'Message'); ?> <span class="required">*</span><br />
        ...
        <tr>
          <td colspan="2"><?php echo $system->language->translate('title_captcha', 'CAPTCHA'); ?> <span class="required">*</span><br />
