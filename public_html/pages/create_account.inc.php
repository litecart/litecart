<?php
  ...
  if (!empty($_POST['create_account'])) {
    ...
    try {
      ...
      if (!functions::validate_password($_POST['password'], 8, 1, 1, 1, 0)) throw new Exception(language::translate('error_password_not_strong_enough', 'The password is not strong enough. It must consist of at least 8 lowercases, uppercases, and numbers'));
