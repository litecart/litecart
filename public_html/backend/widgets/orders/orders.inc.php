  ...
  <table class="table table-striped table-hover data-table">
    ...
    <tbody>
      ...
      <tr class="<?php echo implode(' ', $order_classes); ?>">
        ...
        <td><a href="<?php echo document::href_ilink('orders/edit_order', ['order_id' => $order['id']]); ?>"><?php echo $order['customer_company'] ? $order['customer_company'] : $order['customer_firstname'] .' '. $order['customer_lastname']; ?></a></td>
        ...
        <td class="text-right">
          <a href="<?php echo document::href_ilink('orders/printable_packing_slip', ['order_id' => $order['id'], 'media' => 'print']); ?>" target="_blank" title="<?php echo language::translate('title_packing_slip', 'Packing Slip'); ?>"><?php echo functions::draw_fonticon('fa-file-text-o'); ?></a>
          <a href="<?php echo document::href_ilink('orders/printable_order_copy', ['order_id' => $order['id'], 'media' => 'print']); ?>" target="_blank" title="<?php echo language::translate('title_order_copy', 'Order Copy'); ?>"><?php echo functions::draw_fonticon('fa-print'); ?></a>
          <a href="<?php echo document::href_ilink('orders/edit_order', ['order_id' => $order['id']]); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('edit'); ?></a>
        </td>
      </tr>
    <?php } ?>
    </tbody>
