<?php
  ...
  if (isset($_POST['save'])) {
    ...
    try {
      ...
      header('Location: '. document::ilink('countries/countries'));
      exit;
...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('country_form', 'post', false, false); ?>
      ...
      <div class="card-action">
        ...
        <?php echo (isset($country->data['id'])) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'class="btn btn-danger" onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
      </div>
...
<script>
  ...
  $('form[name="country_form"] .add').click(function(event) {
    ...
    var output = '    <tr>'
               ...
               + '      <td class="text-right"><a class="remove" href="#" title="<?php echo functions::general_escape_js(language::translate('title_remove', 'Remove'), true); ?>"><?php echo functions::general_escape_js(functions::draw_fonticon('remove')); ?></a></td>'
               + '    </tr>';
