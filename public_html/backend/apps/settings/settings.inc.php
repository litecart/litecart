    ...
    <?php echo functions::form_draw_form_begin('settings_form', 'post'); ?>
      ...
      <table class="table table-striped table-hover data-table">
        ...
        <tbody>
          ...
          <?php } else { ?>
          <tr>
            <td class="text-left"><a href="<?php echo document::href_ilink('b:', ['action' => 'edit', 'key' => $setting['key']], true); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo language::translate('settings_key:title_'.$setting['key'], $setting['title']); ?></a></td>
