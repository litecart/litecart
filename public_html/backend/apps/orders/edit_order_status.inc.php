    ...
    <?php echo functions::form_begin('order_status_form', 'post'); ?>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <div>
                <strong><?php echo functions::form_input_checkbox('hidden', ['1', language::translate('text_hidden', 'Hidden')], empty($_POST['hidden']) ? '0' : '1'); ?></strong>
                <?php echo language::translate('text_hidden_from_customer', 'Hidden from the customer\'s order history'); ?>
              </div>

              <div>
                <strong><?php echo functions::form_input_checkbox('is_sale', ['1', language::translate('text_is_sale', 'Is sale')], empty($_POST['is_sale']) ? '0' : '1'); ?></strong>
                <?php echo language::translate('text_include_in_sales_reports', 'Include in sales reports'); ?>
              </div>

              <div>
                <strong><?php echo functions::form_input_checkbox('is_archived', ['1', language::translate('text_is_archived', 'Is archived')], empty($_POST['is_archived']) ? '0' : '1'); ?></strong>
                <?php echo language::translate('text_exclude_from_list_of_orders', 'Exclude from the default list of orders'); ?>
              </div>

              <div class="checkbox">
                <strong><?php echo functions::form_input_checkbox('is_trackable', ['1', language::translate('text_is_trackable', 'Is trackable')], empty($_POST['is_trackable']) ? '0' : '1'); ?> </strong>
            ...
            <div class="form-group col-md-6">
              ...
              <div>
                <strong><?php echo functions::form_input_radio_button('stock_action', ['none', language::translate('title_none', 'None')], empty($_POST['stock_action']) ? 'none' : true); ?></strong>
                <?php echo language::translate('text_stock_remains_without_an_action', 'Stock remains without an action.'); ?>
              </div>

              <div>
                <strong><?php echo functions::form_input_radio_button('stock_action', ['reserve', language::translate('title_reserve_stock', 'Reserve Stock')], true); ?></strong>
                <?php echo language::translate('text_reserve_stock_for_orders_having_this_status', 'Reserve stock for orders having this status.'); ?>
              </div>

              <div class="checkbox">
                <strong><?php echo functions::form_input_radio_button('stock_action', ['commit', language::translate('title_commit_stock', 'Commit Stock')], true); ?> </strong>
        ...
        <div class="col-md-6">
          <fieldset>
            <legend>
              <?php echo functions::form_input_checkbox('notify', ['1', language::translate('title_email_notification', 'Email Notification')], empty($_POST['notify']) ? '0' : '1'); ?>
            </legend>
