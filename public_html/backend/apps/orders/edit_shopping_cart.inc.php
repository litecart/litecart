<?php
  ...
  document::$snippets['title'][] = !empty($shopping_cart->data['id']) ? language::translate('title_edit_shopping_cart', 'Edit Shopping Cart') .' #'. $shopping_cart->data['id'] : language::translate('title_create_new_shopping_cart', 'Create New Shopping Cart');
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('form_shopping_cart', 'post'); ?>
      ...
      <div class="card-action">
        ...
        <?php echo (isset($shopping_cart->data['id'])) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
