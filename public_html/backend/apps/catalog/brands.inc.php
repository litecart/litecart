    ...
    <table class="table table-striped table-hover data-table">
      ...
      <tbody>
        ...
        <tr class="<?php echo empty($brand['status']) ? 'semi-transparent' : ''; ?>">
          ...
          <td><img class="fit" src="<?php echo document::href_rlink($brand['image'] ? FS_DIR_STORAGE . functions::image_thumbnail(FS_DIR_STORAGE . 'images/' . $brand['image'], 16, 16) : 'images/no_image.png'); ?>" alt="" style="width: 16px; height: 16px; vertical-align: bottom;" /> <a href="<?php echo document::href_ilink(__APP__.'/edit_brand', ['brand_id' => $brand['id']]); ?>"><?php echo $brand['name']; ?></a></td>
