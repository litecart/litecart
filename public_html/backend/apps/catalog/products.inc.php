...
<div class="card card-app">
	...
	<div class="card-action">
		<?php echo functions::form_button_link(document::ilink(__APP__.'/edit_product'), language::translate('title_create_new_product', 'Create New Product'), '', 'add'); ?>
	</div>
		...
		<table class="table table-striped table-hover data-table">
			...
			<tbody>
				...
				<tr class="<?php if (empty($product['status'])) echo 'semi-transparent'; ?>">
					...
					<td><?php echo functions::draw_thumbnail('storage://images/' . ($product['image'] ?: 'no_image.png'), 64, 64, settings::get('product_image_clipping')); ?></td>
