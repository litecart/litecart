  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('campaign_form', 'post', false, false, 'style="max-width: 640px;"'); ?>
      ...
      <div class="card-action">
        ...
        <?php echo (isset($campaign->data['id'])) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
