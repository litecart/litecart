  ...
  <div class="card-body">
    <?php echo functions::form_begin('sold_out_status_form', 'post', false, false, 'style="max-width: 640px;"'); ?>
      ...
      <div class="card-action">
        ...
        <?php echo (!empty($sold_out_status->data['id'])) ? functions::form_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
