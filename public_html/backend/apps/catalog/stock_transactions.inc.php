  ...
  <?php echo functions::form_draw_form_begin('stock_transactions_form', 'post'); ?>
    ...
    <table class="table table-striped data-table">
      ...
      <tr>
        ...
        <td><a href="<?php echo document::href_ilink(__APP__.'/edit_stock_transaction', ['transaction_id' => $transaction['id']]); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('edit'); ?></a></td>
      </tr>
      <?php } ?>
      </tbody>
      <tfoot>
