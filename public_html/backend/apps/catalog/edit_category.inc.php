  ...
  <div class="card-body">
    <?php echo functions::form_begin('category_form', 'post', false, true); ?>
      ...
      <div class="card-action">
        ...
        <?php echo !empty($category->data['id']) ? functions::form_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!confirm(&quot;'. language::translate('text_are_you_sure', 'Are you sure?') .'&quot;)) return false;"', 'delete') : false; ?>
