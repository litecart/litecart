<?php
  ...
  if (isset($_POST['save'])) {
    ...
    try {
      ...
      if (!empty($_POST['code']) && database::num_rows(database::query("select id from ". DB_PREFIX ."categories where id != '". (isset($_GET['category_id']) ? (int)$_GET['category_id'] : 0) ."' and code = '". database::input($_POST['code']) ."' limit 1;"))) {
