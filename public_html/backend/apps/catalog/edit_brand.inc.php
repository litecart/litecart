  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('brand_form', 'post', false, true); ?>
      ...
      <div class="card-action">
        ...
        <?php echo (!empty($brand->data['id'])) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'class="btn btn-danger" onclick="if (!window.confirm(\''. language::translate('text_are_you_sure', 'Are you sure?') .'\')) return false;"', 'delete') : false; ?>
