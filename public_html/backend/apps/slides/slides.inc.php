...
<div class="card card-app">
  ...
  <div class="card-action">
    <ul class="list-inline">
      <li><?php echo functions::form_draw_link_button(document::ilink(__APP__.'/edit_slide'), language::translate('title_add_new_slide', 'Add New Slide'), '', 'add'); ?></li>
    </ul>
  </div>
    ...
    <table class="table table-striped table-hover data-table">
      ...
      <tbody>
        ...
        <tr class="<?php echo empty($slide['status']) ? 'semi-transparent' : ''; ?>">
          ...
          <td class="text-end"><a href="<?php echo document::href_ilink(__APP__.'/edit_slide', ['slide_id' => $slide['id']]); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('edit'); ?></a></td>
        </tr>
        <?php } ?>
      </tbody>
