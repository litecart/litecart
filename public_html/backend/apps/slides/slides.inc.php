    ...
    <table class="table table-striped table-hover data-table">
      ...
      <tbody>
        ...
        <tr class="<?php echo empty($slide['status']) ? 'semi-transparent' : ''; ?>">
          ...
          <td class="text-end"><a href="<?php echo document::href_ilink('slides/edit_slide', ['slide_id' => $slide['id']]); ?>" title="<?php echo language::translate('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('edit'); ?></a></td>
        </tr>
        <?php } ?>
      </tbody>
