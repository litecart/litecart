        ...
        <div class="col-md-8">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_email_field('email', true); ?>
            </div>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_text_field('firstname', true); ?>
            </div>

            <div class="form-group col-md-6">
              <label><?php echo language::translate('title_lastname', 'Last Name'); ?></label>
              <?php echo functions::form_text_field('lastname', true); ?>
            </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_password_field('new_password', '', 'autocomplete="new-password"'); ?>
            </div>
          </div>
          ...
          <div class="card-action">
            ...
            <?php echo !empty($customer->data['id']) ? functions::form_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!confirm(&quot;'. language::translate('text_are_you_sure', 'Are you sure?') .'&quot;)) return false;"', 'delete') : false; ?>
