<?php
	...
	$_page->snippets = [
		...
		'credits' => implode(PHP_EOL, [
			'LiteCart contains work by the following:',
			'',
			'# Graphics',
			'',
			'- Logo by T. Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'- Favicon by T. Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'- Cart by T. Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'- Wishlist by T. Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'- NoImage by T. Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'- Newsletter by T. Almroth - CC BY-SA 4.0 - http://www.tim-international.net/',
			'',
			'# Fonts',
			'',
			'- Fira Sans by Google Fonts - Free for commercial use - https://www.googlefonts.com/',
			'- Inter by Google Fonts - Free for commercial use - https://www.googlefonts.com/',
			'- Reprobate (captcha) by Mike Sedillo - Free for commercial use - https://www.apostrophiclab.com/',
			'',
			'# Font Icons',
			'',
			'- Fontawesome - MIT License - https://www.fontawesome.io/',
			'- Material Symbols - Apache License Version 2.0 - https://fonts.google.com/icons',
			'- T .Almroth - CC BY-SA 4.0 - https://www.tim-international.net/',
			'',
			'# Javascript',
			'',
