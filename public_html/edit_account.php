<?php
  ...
  if (!empty($_POST['save'])) {
    ...
    if (empty($_POST['country_code']) && functions::reference_country_num_zones($_POST['country_code'])) notices::add('errors', language::translate('error_missing_zone', 'You must select a zone.'));
    ...
    if (!empty($_POST['different_shipping_address'])) {
      ...
      if (empty($_POST['shipping_address']['country_code']) && functions::reference_country_num_zones($_POST['shipping_address']['country_code'])) notices::add('errors', language::translate('error_missing_zone', 'You must select a zone.'));
    }
...
?>
  <div class="box">
    <div class="heading"><h1><?php echo language::translate('title_customer_information', 'Customer Information'); ?></h1></div>
    <div class="content" style="padding: 0px;">
      <?php echo functions::form_draw_form_begin('customer_form', 'post'); ?>
        <table style="width: 100%">
          <tr>
            <td style="width: 50%;">
              <table>
                ...
                <tr>
                  <td><?php echo language::translate('title_email', 'E-mail'); ?><br />
              ...
              <div id="shipping-address-container"<?php echo (empty($_POST['different_shipping_address'])) ? ' style="display: none;"' : false; ?>>
                <table>
                  ...
                  <tr>
                    ...
                    <td><?php echo language::translate('title_postcode', 'Postcode'); ?><br />
                      <?php echo functions::form_draw_text_field('shipping_address[postcode]', true); ?></td>
                  </tr>
                  <tr>
                    <td><?php echo language::translate('title_country', 'Country'); ?><br />
          ...
          <tr>
          <td colspan="2" align="center"><?php echo functions::form_draw_button('save', language::translate('title_save', 'Save')); ?></td>
          </tr>
        </table>
