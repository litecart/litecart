  ...
  <div class="content" id="order_confirmation-wrapper">
    <table class="dataTable rounded-corners" style="width: 100%;">
      <tr class="header">
        ...
        <th style="vertical-align: text-top" align="right" nowrap="nowrap" width="100"><?php echo (settings::get('display_prices_including_tax')) ? language::translate('title_incl_tax', 'Incl. Tax') : language::translate('title_excl_tax', 'Excl. Tax'); ?></th>
...
?>
      <tr>
        <td colspan="5" align="right" style="color: #999999;"><?php echo (settings::get('display_prices_including_tax')) ? language::translate('title_including_tax', 'Including Tax') : language::translate('title_excluding_tax', 'Excluding Tax'); ?>:</td>
