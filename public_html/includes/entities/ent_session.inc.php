		...
		public function save() {
			...
			database::query(
				...
				set customer_id = ". (!empty($this->data['customer_id']) ? (int)$this->data['customer_id'] : "null") .",
					data = '". database::input(json_encode($this->data['data'], JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE)) ."',
					...
					data = '". database::input(json_encode($this->data['data'])) ."',
