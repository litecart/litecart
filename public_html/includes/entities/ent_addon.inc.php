<?php
	...
	class ent_addon {
		...
		public function save(): void {
			...
			$marketplace_node->appendChild( $dom->createElement('addon_id', $this->data['marketplace']['addon_id'] ?? '') );
			$marketplace_node->appendChild( $dom->createElement('expires_at', $this->data['marketplace']['expires_at'] ?? '') );
		...
		public function delete(bool $cleanup = false): void {
			...
			f::file_delete($this->previous['location'], true);
