<?php
  ...
  class func_draw {
    ...
    public static function draw_img($image, $width, $height, $title, $params) {
      return '<img src="'. $image .'" width="'. $width .'" height="'. $height .'" border="0"'. ($params ? ' '.$params : '') .'/>';
    }
    
    public static function draw_listing_category($category) {
    ...
    public static function draw_listing_manufacturer($manufacturer) {
    ...
    public static function draw_listing_product($product) {
      trigger_error('The public static function draw_listing_product() is deprecated, use instead draw_listing_product_column()', E_USER_DEPRECATED);
      return functions::draw_listing_product_column($product);
    }

    public static function draw_listing_product_column($product) {
    ...
    public static function draw_listing_product_row($product) {
    ...
    public static function draw_fancybox($selector='a.fancybox', $params=array()) {
    ...
    public static function draw_pagination($pages) {
