<?php
  ...
  function draw_lightbox($selector='', $params=[]) {
    ...
    document::$snippets['head_tags']['featherlight'] = '<link rel="stylesheet" href="'. document::href_rlink(FS_DIR_APP . 'vendor/featherlight/featherlight.min.css') .'" />';
    document::$snippets['foot_tags']['featherlight'] = '<script src="'. document::href_rlink(FS_DIR_APP . 'vendor/featherlight/featherlight.min.js') .'"></script>';
