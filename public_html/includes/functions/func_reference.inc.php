<?php
  ...
  class func_reference {
    
    public static function reference_in_geo_zone($geo_zone_id, $country_code, $zone_code='') {
    ...
    public static function reference_get_manufacturer_name($manufacturer_id) {
    ...
    public static function reference_get_country_name($code) {
    ...
    public static function reference_get_zone_name($country_code, $code) {
    ...
    public static function reference_country_num_zones($country_code) {
    ...
    public static function reference_verify_zone_code($country_code, $code) {
    ...
    public static function reference_get_postcode_required($country_code) {
