<?php
  ...
  function draw_listing_product($product) {
    ...
    $output = '<li class="product shadow hover-light" style="position: relative">' . PHP_EOL
          ...
          //. '  <div style="text-align: center;" class="buy_now">'.  functions::form_draw_form_begin('buy_now_form') . functions::form_draw_hidden_field('product_id', $product['id']) . functions::form_draw_button('add_cart_product', language::translate('title_add_to_cart', 'Add To Cart'), 'submit') . functions::form_draw_form_end() .'</div>' . PHP_EOL
            . '</li>' . PHP_EOL;
  ...
  function draw_pagination($pages) {
    ...
    if ($_GET['page'] > 1) {
      //$html .= '    <li><a class="page button" href="'. document::href_link('', array('page' => 1), true) .'">'. language::translate('title_first', 'First') .'</a></li>' . PHP_EOL;
      ...
      //$html .= '    <li><span class="page button disabled" href="'. document::href_link('', array('page' => 1), true) .'">'. language::translate('title_first', 'First') .'</span></li>' . PHP_EOL;
    ...
    if ($_GET['page'] < $pages) {
      ...
      //$html .= '    <li><a class="page button" href="'. document::href_link('', array('page' => $pages), true) .'">'. language::translate('title_last', 'Last') .'</a></li>' . PHP_EOL;
    } else {
      $html .= '    <li><span class="page button disabled">'. language::translate('title_next', 'Next') .'</span></li>' . PHP_EOL;
      //$html .= '    <li><span class="page button disabled">'. language::translate('title_last', 'Last') .'</span></li>' . PHP_EOL;
    }
