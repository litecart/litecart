<?php
  ...
  class func_form {
    ...
    public static function form_draw_form_begin($name='', $method='post', $action=false, $multipart=false, $parameters='') {
      return  '<form'. (($name) ? ' name="'. htmlspecialchars($name) .'"' : false) .' method="'. ((strtolower($method) == 'get') ? 'get' : 'post') .'" enctype="'. (($multipart == true) ? 'multipart/form-data' : 'application/x-www-form-urlencoded') .'"'. (($action) ? ' action="'. htmlspecialchars($action) .'"' : '') . (($parameters) ? ' ' . $parameters : false) .'>'. PHP_EOL
            . ((strtolower($method) == 'post') ? functions::form_draw_hidden_field('token', form::session_post_token()) . PHP_EOL : '');
    }
    
    public static function form_draw_form_end() {
      return '</form>' . PHP_EOL;
    }
    
    public static function form_reinsert_value($name, $array_value=null) {
    ...
    public static function form_draw_button($name, $value, $type='submit', $parameters='', $icon='') {
    ...
    public static function form_draw_checkbox($name, $value, $input=true, $parameters='', $hint='') {
      if ($input === true) $input = functions::form_reinsert_value($name, $value);
    ...
    public static function form_draw_currency_field($currency_code, $name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_date_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_datetime_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_decimal_field($name, $value=true, $decimals=2, $min=0, $max=0, $parameters='', $hint='') {
    ...
    public static function form_draw_email_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_file_field($name, $parameters='', $hint='') {
    ...
    public static function form_draw_hidden_field($name, $value=true, $parameters='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
      
      return '<input type="hidden" name="'. htmlspecialchars($name) .'" value="'. htmlspecialchars($value) .'"'. (($parameters) ? ' '.$parameters : false) .' />';
    }
    
    public static function form_draw_image($name, $src, $parameters=false) {
    ...
    public static function form_draw_input($name, $value=true, $type='text', $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_link_button($url, $title, $parameters='', $icon='') {
    ...
    public static function form_draw_number_field($name, $value=true, $min='', $max='', $parameters='', $hint='') {
    ...
    public static function form_draw_password_field($name, $value=true, $parameters='', $hint='') {
      if (!preg_match('/data-size="[^"]*"/', $parameters)) $parameters .= (!empty($parameters) ? ' ' : null) . 'data-size="medium"';
    ...
    public static function form_draw_radio_button($name, $value, $input=true, $parameters='', $hint='') {
      if ($input === true) $input = functions::form_reinsert_value($name, $value);
    ...
    public static function form_draw_range_slider($name, $value=true, $min='', $max='', $step='', $parameters='', $hint='') {
      if (!preg_match('/data-size="[^"]*"/', $parameters)) $parameters .= (!empty($parameters) ? ' ' : null) . 'data-size="medium"';
    ...
    public static function form_draw_regional_input_field($language_code, $name, $value=true, $parameters='', $hint='') {
      return '<span class="input-wrapper"><img src="'. WS_DIR_IMAGES .'icons/languages/'. $language_code .'.png" width="16" style="vertical-align: middle;" /> '. functions::form_draw_text_field($name, $value, $parameters, $hint) .'</span>';
    }
    
    public static function form_draw_regional_textarea($language_code, $name, $value=true, $parameters='', $hint='') {
      return '<span class="input-wrapper"><img src="'. WS_DIR_IMAGES .'icons/languages/'. $language_code .'.png" width="16" style="vertical-align: top;" /> '. functions::form_draw_textarea($name, $value, $parameters, $hint) .'</span>';
    }
    
    public static function form_draw_regional_wysiwyg_field($language_code, $name, $value=true, $parameters='', $hint='') {
      return '<span class="input-wrapper"><img src="'. WS_DIR_IMAGES .'icons/languages/'. $language_code .'.png" width="16" style="vertical-align: top;" /> '. functions::form_draw_wysiwyg_field($name, $value, $parameters, $hint) .'</span>';
    }
    
    public static function form_draw_search_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_select_field($name, $options=array(), $input=true, $multiple=false, $parameters='', $hint='') {
      ...
      foreach ($options as $option) {
        if ($input === true) {
          $option_input = functions::form_reinsert_value($name, isset($option[1]) ? $option[1] : $option[0]);
        } else {
          $option_input = $input;
        }
    ...
    public static function form_draw_static_field($name, $value=true, $parameters='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_textarea($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_text_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name, $value);
    ...
    public static function form_draw_time_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_toggle($name, $input=true, $type='e/d') {
      if ($input === true) $input = functions::form_reinsert_value($name);
    ...
    public static function form_draw_url_field($name, $value=true, $parameters='', $hint='') {
      if ($value === true) $value = functions::form_reinsert_value($name);
    ...
    public static function form_draw_wysiwyg_field($name, $value=true, $parameters='', $hint='') {
    ...
    public static function form_draw_function($function, $name, $input=true) {
      
      preg_match('/(\w*)(?:\()(.*?)(?:\))/i', $function, $matches);
      
      if (!isset($matches[1])) trigger_error('Invalid public static function name ('. $function .')', E_USER_ERROR);
      ...
      switch ($matches[1]) {
        ...
        case 'radio':
          $output = '';
          for ($i=0; $i<count($options); $i++) $output .= ' <label>'. functions::form_draw_radio_button($name, $options[$i], $input) .' '. $options[$i] .'</label>';
          return $output;
        case 'select':
        ...
        case 'templates':
          return functions::form_draw_templates_list($options[0], $name, $input);
        case 'toggle':
        ...
        case 'zones':
          $option = !empty($options) ? $options[0] : settings::get('store_country_code');
          return functions::form_draw_zones_list($option, $name, $input);
        default:
          trigger_error('Unknown public static function name ('. $function .')', E_USER_ERROR);
      }
    }
    
    public static function form_draw_categories_list($name, $input=true, $multiple=false, $parameters=false) {
    ...
    public static function form_draw_countries_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_currencies_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_customers_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_delivery_status_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_geo_zones_list($name, $input=true, $multiple=false, $parameters='') {
      ...
      if (database::num_rows($geo_zones_query) == 0) {
        return functions::form_draw_hidden_field($name, '0') . functions::form_draw_select_field($name, $options, $input, false, false, $parameters . ' disabled="disabled"');
      }
    ...
    public static function form_draw_languages_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_length_classes_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_manufacturers_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_option_groups_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_option_values_list($group_id, $name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_order_status_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_products_list($name, $input=true, $multiple=false, $parameters) {
    ...
    public static function form_draw_product_stock_options_list($product_id, $name, $input=true, $multiple=false, $parameters) {
    ...
    public static function form_draw_sold_out_status_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_suppliers_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_templates_list($type='catalog', $name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_timezones_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_tax_classes_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_weight_classes_list($name, $input=true, $multiple=false, $parameters='') {
    ...
    public static function form_draw_zones_list($country_code, $name, $input=true, $multiple=false, $parameters='', $preamble='none') {

      if ($country_code == '') $country_code = settings::get('default_country_code');
    
      if ($input === true) $input = functions::form_reinsert_value($name);
      
      if ($input == '') $input = settings::get('default_zone_code');
      ...
      if (database::num_rows($zones_query) == 0) {
        return functions::form_draw_hidden_field($name, '') . functions::form_draw_select_field($name, $options, $input, $multiple, $parameters . ' disabled="disabled"');
      }
