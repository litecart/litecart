<?php
  ...
  class func_email {
    ...
    public static function email_send($from, $recipients, $subject='(No subject)', $message, $html=false, $attachments=array()) {
    ...
    public static function email_validate_address($address) {
