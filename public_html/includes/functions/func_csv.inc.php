<?php
  ...
  class func_csv {
    ...
    public static function csv_encode($array, $delimiter=',', $enclosure='"', $escape='\\', $charset='utf-8', $eol="\r\n") {
    ...
    public static function csv_decode($string, $delimiter=',', $enclosure='"', $escape='\\', $charset='utf-8') {
