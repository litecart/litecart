<?php
  ...
  class func_image {
    ...
    public static function image_delete_cache($file) {
    ...
    public static function image_resample($source, $target, $target_width=0, $target_height=0, $method='FIT_ONLY_BIGGER', $watermark=false) {
