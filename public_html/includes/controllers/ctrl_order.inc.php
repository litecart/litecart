    ...
    // Insert/update order
      if (empty($this->data['id'])) {
        database::query(
          ...
          values ('". database::input($this->data['uid']) ."', '". database::input($_SERVER['REMOTE_ADDR']) ."', '". database::input($_SERVER['USER_AGENT']) ."', '". database::input($_SERVER['HTTP_HOST']) ."', '". date('Y-m-d H:i:s') ."');"
        );
