...
?>
<div id="region">
  <div class="language"><img src="<?php echo WS_DIR_IMAGES .'icons/languages/'. language::$selected['code'] .'.png'; ?>" alt="<?php echo language::$selected['name']; ?>" /></div>
  <div class="currency"><?php echo currency::$selected['code']; ?></div>
