<?php
  ...
  $box_similar_products_cache_token = cache::token('box_similar_products', array($_GET['product_id'], !empty($_GET['category_id']) ? $_GET['category_id'] : implode(', ', array_keys($product->categories)), 'language', 'currency'), 'file');
