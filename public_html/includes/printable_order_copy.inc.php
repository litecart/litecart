...
<div id="body">
  <table width="100%" style="border: 1px solid #666;">
    ...
    <tr>
      <td align="left"><strong><?php echo $this->system->language->translate('title_payment_option', 'Payment Option'); ?>:</strong><br />
    ...
    <tr>
      <td align="left"><strong><?php echo $this->system->language->translate('title_transaction_number', 'Transaction Number'); ?>:</strong><br />
        <?php echo $order['payment_transaction_id'] ? $order['payment_transaction_id'] : '-'; ?>
      </td>
      <td align="left"><strong><?php echo $this->system->language->translate('title_weight', 'Weight'); ?>:</strong><br />
  ...
  <table width="100%" style="border: 1px solid #666; font-size: 0.9;">
    <tr>
      <th nowrap="nowrap" style="vertical-align: text-top" align="center" width="30"><?php echo $this->system->language->translate('title_qty', 'Qty'); ?></th>
      <th style="vertical-align: text-top" align="left"><?php echo $this->system->language->translate('title_item', 'Item'); ?></th>
      <th nowrap="nowrap" style="vertical-align: text-top" align="right" width="100"><?php echo $this->system->language->translate('title_unit_price', 'Unit Price'); ?></th>
      <th nowrap="nowrap" style="vertical-align: text-top" align="right" width="100"><?php echo ($this->system->settings->get('display_prices_including_tax') == 'true') ? $this->system->language->translate('title_including_tax', 'Including Tax') : $this->system->language->translate('title_excluding_tax', 'Excluding Tax'); ?> </th>
      <th nowrap="nowrap" style="vertical-align: text-top" align="right" width="100"><?php echo $this->system->language->translate('title_sum', 'Sum'); ?></th>
    </tr>
...
?>
    ...
    <?php if ($this->system->settings->get('display_prices_including_tax') == 'true') { ?>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['price'] + $item['tax'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['tax'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['quantity'] * ($item['price'] + $item['tax']), false, false, $order['currency_code'], $order['currency_value']); ?></td>
    <?php } else { ?>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['price'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['tax'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
      <td nowrap="nowrap" align="right"><?php echo $this->system->currency->format($item['quantity'] * $item['price'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
    <?php } ?>
    </tr>
    <?php } ?>
  </table>
  ...
  <table width="100%">
    ...
    <tr>
      <td align="right"><?php echo ($this->system->settings->get('display_prices_including_tax') == 'true') ? $this->system->language->translate('title_including_tax', 'Including Tax') : $system->language->translate('title_excluding_tax', 'Excluding Tax'); ?> (<?php echo $tax_rate['name']; ?>):</td>
      <td align="right"><?php echo $this->system->currency->format($tax_rate['tax'], false, false, $order['currency_code'], $order['currency_value']); ?></td>
    </tr>
    <?php } ?>
    <?php } ?>
    <tr>
