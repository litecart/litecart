<main id="content">
  ...
  <div id="box-order-success" class="box">
    ...
    <p><a href="<?php echo htmlspecialchars($printable_link); ?>" data-toggle="lightbox" data-type="iframe" data-width="21cm" data-height="29.7cm"><?php echo language::translate('description_click_printable_copy', 'Click here for a printable copy'); ?></a></p>
