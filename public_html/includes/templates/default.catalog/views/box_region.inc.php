<div id="region">
  ...
  <div class="country"><img src="<?php echo document::href_link('images/countries/'. strtolower(customer::$data['country_code']) .'.png'); ?>" style="vertical-align: baseline;" alt="<?php echo customer::$data['country_code']; ?>" title="<?php echo functions::escape_html(reference::country(customer::$data['country_code'])->name); ?>" /></div>
