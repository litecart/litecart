  ...
  <div style="padding: 0px 10px;">
    <header id="header" class="twelve-eighty">
      ...
      <div id="logotype-wrapper">
        <a href="<?php echo document::href_ilink(''); ?>"><img src="<?php echo WS_DIR_IMAGES; ?>logotype.png" style="max-width: 220px; max-height: 60px;" alt="<?php echo settings::get('store_name'); ?>" /></a>
      </div>
