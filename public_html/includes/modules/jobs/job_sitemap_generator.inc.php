		...
		function settings() {
			...
			return [
				...
				[
					...
					'default_value' => '1000',
					'title' => language::translate(__CLASS__.':title_entries_per_sitemap', 'Entries Per Sitemap'),
					'description' => language::translate(__CLASS__.':description_entries_per_sitemap', 'The number of entries per sitemap file.'),
					'function' => 'number()',
				],
				[
					'key' => 'priority',
